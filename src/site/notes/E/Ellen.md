---
{"dg-publish":true,"permalink":"/E/Ellen/","title":"Ellen","tags":["containstransclusions"],"created":"2026-02-13T03:30","updated":"2026-02-13T03:31"}
---
...
- Harcról lesz szó alul a latin szónál is.

Azért is érdekes, mert kezdetben [[S/Széth\|Széth]] is pozitív Isten, sőt, az első Isten, aki démonizálva vált, Ozirisz és Hórusz ellenfelévé.  
Másképpen:  
[[S/SZET\|Szet]] először Kezdet, majd (akár mint Széth) már Sötétséget képviselő Ellen(fél).  
- A [[S/Sátán\|Sátán]] is előbb semleges, utóbb lesz negatív, ahogy az ősi szűzállapot vagy az örök nő sem lehet negatívan értékelendő.

> [!info] &nbsp;
> Ellen ezek alapján "Első Isteni Én" is lehet.  
> [[C/Csudaszarvas\|Csudaszarvas]] és [[I/Ilona\|Ilona]] (és [[E/Elk\|elk]]) címnél írottak alapján is ki lehet indulni. Ilona az aki "elli" a Napot, akinek [[P/Precesszió\|precesszió]]s értelemben ellen-Napja van.

Úgy tűnik, hogy [[A/Ál\|ál]] szavunk kapcsán is ugyanezt mondhatjuk el: [[E/EL\|EL]]/[[E/ÉL\|ÉL]] isten ellenpárjáról lenne szó, a másik oldalról, ami nem az igazit/igazat képviseli.  
...
Szíriusz és Szaturnusz égitestekben az a közös, hogy mindkettő kapcsolódik [[S/Széth\|Széth]]hez. Nos, valójában Szíriusz itt Orion-Szíriusz. És [[S/Szaturnusz#Szaturnusz és Orion\|Szaturnusz és Orion]] cím/alcímnél is kimondtuk, hogy megfelelnek egymásnak.  
Ezek alapján a [[K/Kontár\|kontár]] címnél is említett latin [[C/Contra-\|contra-]] is lehet Hun-Tár = Hun (társ/ellen-)Nap, vagy [[H/Hunter\|hunter]] = [[V/Vadász\|vadász]], aki a Csudaszarvasünőt űzi, s hajtja a csillagképeket. Sőt, a Hunter Vadász lehet maga a [[H/Hunor csillagkép\|Hunor csillagkép]] azaz [[I/Íj csillagkép\|Íj csillagkép]] is, mely valóban ellene = szemben van a másik Nyilazó/Nyilassal és a Tejútközponttal.  
A legutóbb [[U/Ullu\|Ullu]] (ez is hasonló szó) címnél írottak is ide passzolnak.  
...
Itt a szokásos, [[S/Szűz csillagkép\|Szűz csillagkép]] címnél is taglalt problematikát találjuk, ahol a [[S/Sothis\|Sothis]]-Szíriusz nevet akartuk egy nevezőre hozni a Szűz nevével.  

[[M/Más\|Más]] és [[M/Második\|második]] címnél írottak alapján is lehet ellenre gondolni; lásd még diagramot [[M/MISZ\|MISZ]].  
De aztán még ott az igen érdekes alkotású [[A/Anti-\|anti-]] mellyel egyeztethető a(z [[A/Ancient\|ancient]] címnél taglalt) latin `ante` = előtt, [[A/Anta\|anta]] = Nap és az [[A/Andra\|Andra]], [[O/Other\|other]], [[A/Alter\|alter]] és másutt előjövő más(ik csillag/Nap) jelentést hordozó, arra utaló szavak.  

[[H/HAN\|Han]] címnél írottak jutottak eszembe, amikor a Quorán ezen Why do Germanic languages have an etymological relationship between "again" and "against" (also in German "wider" vis à vis "wieder")? What was the initial semantic relationship that connected those two words? kérdésre [ezen](https://qr.ae/pNc7ZL) válaszban a [[G/Gainsay\|gainsay]] és [[A/Against\|against]] címnél is taglalt fogalmakat járja körbe a német válaszadó. Ő az idő megfordulásáról beszél, holott itt is az [[E/Életkör\|életkör]] a keresett fogalom. Ami jön, az megy. Azaz a [[J/Jön\|jön]]/hun szavak és az ezekkel azonos [[K/KAN\|KAN]] szó alaki párját kell gain-ben keresni. Mely kan a [[K/Kantár\|kantár]] szóban is szerepel, mely a [[C/Counter\|counter]] = ellen szó eredetét is megadja.  
A latin `versus` = ellen, szemben is a `vertere` = forgás (és magyar [[V/Verseny\|verseny]]) szóval hozható úgy kapcsolatba, ahogy az ellen szavunk Ilona (csillagának, a Szíriusznak) forgásával. Illan is lehet ellen párja.
{ #250503}


A magyarra visszatérve ellentétpárt alkot az [[I/Ilyen\|ilyen]] és [[O/Olyan\|olyan]]: egyszer ilyen (fényes, hű, rendes, igaz, szent), másszor olyan (sötét, hűtlen, gaz, hamis). ([[S/Sötét oldal\|Sötét oldal]] címnél lélektanról is volt szó; a mániás depressziós, bipoláris, a tudathasadásos ember is egyszer ilyen, egyszer olyan.)  
Az ilyen és olyan szavak az ellen, valamint az [[I/Itt\|itt]] és [[O/Ott\|ott]] szavak sémáját veszik fel, de `ily` itt is az [[E/ÉL\|ÉL]] ([[I/IL\|IL]]), Oly pedig a [[H/HAL\|HAL]] párjai is.  

Ne feledjük el az [[E/Ell\|ell]]ik = szül szavunkat sem.  

Innenről és túlnanról is lehetne beszélni.  
