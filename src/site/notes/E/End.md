...
A germán nyelvek `end`, `ende` szavainak jelentései: vég, vége valaminek, végződik.  
...
Úgy tűnik, [[V/Vég\|vég]], [[K/Köt\|köt]], [[T/Tail\|tail]], valamint a [[K/Kezdet és vég\|kezdet és vég]] címnél írottak alapján, hogy az (inda helyett) [[I/Indul\|indul]] – end megfeleltetés lehetne helyes. A vég egyben valami új kezdete, új indulása.  
Az [ezen](https://en.wiktionary.org/wiki/%E0%A4%85%E0%A4%A8%E0%A5%8D%E0%A4%A4#Sanskrit) oldalon is taglalt szanszkrit `अन्त॑` (`ánta`; vö. hindi `ant`) = vég viszont kimondottan az [[A/Anta\|anta]] = Nap szót idézi. A török `son` = vég, halál szóban is a [[S/SZON\|Szon]] Napnév szerepel (ott a [[S/Suny\|suny]], [[S/SZÜN\|szün]] = vég mutat Nap fényének végleges eltűnésére).  
...
Legutóbb [[I/Idus\|idus]] címnél is felvetettem, hogy `end` is vélhetően [[I/Idő\|idő]] szavunkból ered, csak egy a hun(-gót) nyelvre jellemző orrhang került bele.  
...
Van még egy vizsgálati vonal: a német `eng` = szoros, szűk fogalmának [[Z/Zár\|zár]] fogalmához állíthatósága révén megint az idő köréhez jutunk vissza. G>D váltás nem szabályos, de [[M/Mássalhangzók felcserélődése#B-D-G mássalhangzók változásai\|mássalhangzók felcserélődése]] helyen volt róla szó.  
