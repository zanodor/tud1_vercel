...
<!--section: 3.1-->
...abr elvont gyöknél (mely az abrosz, abroncs gyöke) hozott példái:  
...
<!--section: 4.1-->
Megint eltakarás témában:  

A [daugan](https://en.wiktionary.org/wiki/Reconstruction:Proto-West_Germanic/daugan) Wiktionary helyen taglalt metatézis egy PIE \*dʰéwk-e-ti és \*kéwdʰ-e-ti megállapított gyököket érint, azzal a céllal, hogy meghatározzák a `dye` eredetét egy olyan lefed, eltakar jelentéssel, mely [[D/DAK\|DAK]] helyen is taglalt tető jelentésű, [[T/Takar\|takar]] szavunk gyökének megfelelő szavakban is megvolt.
{ #v1fsrz}
