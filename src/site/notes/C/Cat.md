---
{"dg-publish":true,"permalink":"/C/Cat/","title":"Cat","tags":["containstransclusions","Englishtexttranslated"],"created":"2023-11-17T08:48","updated":"2026-03-25T02:20"}
---
...
| :--- | :--- | :--- | :--- | :--- |
| **Szerb** | Nem használják (archaikus) | **Nem használják** | **mačka** (nőnem) | **pička** (trágár) |
| **Horvát** | Nem használják (archaikus) | **Nem használják** | **mačka** (nőnem) | **pička** (trágár) |
| **Bosnyák** | Nem használják (archaikus) | **Nem használják** | **mačka** (nőnem) | **pička** (trágár) |
| **Montenegrói** | Nem használják (archaikus) | **Nem használják** | **mačka** (nőnem) | **pička** (trágár) |
| **Lengyel** | **Használják** (hímnem) | **Nem használják** | **kot** (hímnem) | **cipka** (trágár) |
| **Szlovák** | **Használják** (hímnem) | **Nem használják** | **mačka** (nőnem) | **pica** (trágár) |
| **Orosz** | **Használják** (hímnem, "kot") | **Nem használják** | **кот** ("kot", hímnem) | **пизда** (trágár) |
| **Cseh** | **Használják** (ritka/gyökér) | **Nem használják** | **kočka** (nőnem) | **pička** (trágár) |
| **Bolgár** | **Használják** (gyökérként) | **Nem használják** | **котка** (kotka) | **путка** (trágár) |
