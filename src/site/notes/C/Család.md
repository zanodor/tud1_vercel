...
Elsődleges jelentése volt a gyerek és másodlagos a ma elterjedtebb használat, família jelentéssel, írja Péterfai János. Lásd Péterfai írását (és azóta a sajátomat) is [[C/Child\|child]], valamint még [[H/Hold\|Hold]].  
...
Ezen szavakat közben [[C/Child\|child]] és [[T/Törzs\|törzs]] címnél is említettük. Lásd előbbi címnél írottakat, ha már ide nem kerültek át.  
A [[C/Csillag\|csillag]] címnél említett szláv `cselovek` = ember is ilyen gyökű.  
Lásd még hasonló szavakról [[C/Clan\|clan]] és [[G/Gulya\|gulya]].  
