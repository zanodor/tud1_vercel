...
A bot hímtag jelentésével kapcsolatosan felhozható a latin `futuere` = baszni és `battuere` = ütni, mely szavakat Eric Partridge egy, a magyarral azonos **ír `bot` = hímtag** szóval rokonít, helyesen.  
