---
{"dg-publish":true,"permalink":"/S/Szláv mitológia/","title":"Szláv mitológia","tags":["Englishtexttranslated"],"created":"2025-09-28T20:49","updated":"2026-08-03T20:44"}
---
...
> The same kind of transformation occurrred with the concept of devil. The ancient Slavs believed in a deity of winter and death[^3] (devil – `chyort`), the personification of winter gloom and cold. The word `chyort` in all the Slavic languages is the personification of an evil supernatural force. `Chyort` has become synonymous with the Christian devil.  
> —  
...
> Ugyanez a fajta átalakulás történt az ördög fogalmával is. Az ősi szlávok hittek a tél és a halál istenségében [^3] (ördög – `csjort`), a téli sötétség és hideg megszemélyesítőjében. A `csjort` szó minden szláv nyelvben egy gonosz természetfeletti erő megszemélyesítője. `Csjort` a keresztény ördög szinonimájává vált. 

A fent említett Svarog nevet a valahol említett, Bakos Attila A Duna Evangéliuma című könyvében adatolt szanszkrit `svarga` = menny szóval szokták kapcsolatba hozni. Bizánci krónika szláv fordításában Svarog a kovácsisten [[H/Héphaisztosz\|Héphaisztossz]]al azonosítva kerül elő.  
