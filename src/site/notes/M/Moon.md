...
Ugyanis sokkal valószínűbb, hogy a [[M/Men\|meny]] lesz a hold névadója.  
...
<!--section: 1.1-->
A Nap égitesttel és magával szavunkkal Ipolyi Arnold Magyar mythologia című könyvének 322. oldalától foglalkozik. Egészen jó meglátásai voltak és jó rokonításokat hoz.  
...
Lásd például [[K/KUN\|KUN]] és hozzá hasonló Nap jelentésű szavaink eredetét illetve [[N/Nut\|Nut]] és [[G/Galactic centre\|Tejútközpont]] címnél írottakat.  
...
<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/H/Hunor és Magor/#4b8bui" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
Utódnyelveinkben is bőven megtalálhatjuk e szavunkat. Lásd [[K/Knap\|knap]], [[K/Knob\|knob]], [[N/Nab\|nab]], [[N/Nap#Nap 2)\|nap]], [[N/Nape\|nape]], [[N/Napa#Napa 2)\|napa]], [[N/Naphtha\|naphtha]], [[N/Nave\|nave]], [[N/Navel\|navel]], [[N/New\|new]], [[N/Navy\|navy]], [[N/Navigate\|navigate]], [[N/Nova\|nova]], stb.  
...
A chilei spanyol nyelvben [[N/Nepe\|nepe]] = hímtag (de `pene` = fene hangátvetésének is felfogható). Mivel farka a skorpiónak is van, így érthető, hogy a Valpy latin etimológia szótárában ismeretlen afrikai(?!) eredettel megjelölt nepa = skorpió szó eredete is itt keresendő.  
...
<!--section: 7.1-->
...című könyvében hoz érdekes nevet:  
> Az indonéz kenyah törzs tau nemzetségének a névadó totemőse Tau, a Nap. A fekete-afrikai mosszi birodalom, Uaga-dugu királyát, Moro Nabát a Naphoz hasonlították.  
- A Moro a Maharo/Magyar névhez, Naba a Nap névhez hasonlítható.

További érdekességek: dán `næb` = csőr; koreai `nabi` = pillangó.  
...
[Ezen](https://en.wiktionary.org/wiki/%E6%B2%96%E7%B8%84#Japanese) oldal alapján Okinawa szigete nevének eredetéről van szó. Érdekes, hogy Okinapa forma is előjön. Márpedig a japán `nawa` = kötél ([[R/Rope\|rope]] címnél is előjött a Nap etimonja) amennyiben napa lett volna eredetileg, megint csak tökéletes egyezés.  
...
> A Nap a Teremtőeszme, a tiszta Gondolat ([[L/Logosz\|Logos]]) jelképe. Napjellegű minden, ami első helyen, magasan áll: uralkodók, államfők, nagy befolyású, előkelő emberek, magas rangú köztisztviselők, főpapok, vezetők; általában az állam maga, a hatóságok, a felsőbbség.  
...
- Másutt a Róheim Gézát idéző Magyar Adorjánnál: `teo-kutatl`.
...
> A sima kör, a pontos kör: ![assets/NapMAIN_image4.png|fix_dark fix_light|18](/img/user/N/assets/NapMAIN_image4.png), ez utóbbi egyiptomi eredetű, s a Nap asztrológiai-asztronómiai jele –, az egyenlő szárú kereszt, a szvasztika (horogkereszt, "forgó" kereszt; lásd [[S/Swastika\|swastika]]) adott összefüggésben mind napjelek. A kör (mint a szentostya, vagy az uralkodó képmását viselő aranypénz) nemcsak az égitest formájára utal, hanem körpályájára is. A [[K/Kereszt\|kereszt]] a nappálya főbb állomásait (az égtájakat) mutatja.  
...
![assets/NapMAIN_image5.png|fix_dark fix_light](/img/user/N/assets/NapMAIN_image5.png)  

Álljon itt még egy csatolt képi anyag Bal Gangadhar Tilak Orion or the Antiquity of the Vedas c. könyvének 179. oldaláról, mely arról szól, hogy a hindu év első (Devayana – lásd erről [[B/Bal és jobb\|bal és jobb]]) féléve az Orion heliakálisan kelésétől (ismerős a történet: lásd [[S/Szíriusz heliakus kelése\|Szíriusz heliakus kelése]]) az Orion akronikális keléséig tartott.  

<!--section: 16-->
## Nap és négy (irány) – Napkereszt

<!--section: 16.1-->
![assets/NapMAIN_image6.png|fix_dark fix_light](/img/user/N/assets/NapMAIN_image6.png)  
[[N/Négy\|Négy]] és [[K/Kereszt\|kereszt]] címnél volt szó a témáról és a [[K/Keresztrefeszített Nap\|keresztrefeszített Nap]] fogalmát is ismerjük. Itt csak annyit, hogy [[K/Kereszt\|kereszt]] címnél és például [[H/Hold\|Hold]] címnél is szerepeltek olyan képek, amelyeket ide tehetők lennének. Illetve kicsiben ide is tenném őket.  
A [[B/Bal és jobb\|bal és jobb]] címnél és [[K/Kereszt\|kereszt]] címnél is bemutatott Altyn Tepe-i leleten bal oldalon kereszttel ábrázolt Nap azért érdekes, mert még a Nap körét sem jelölték. A [[P/Plus\|plus]] jel pozítív és hozzáadó értelmét is így értjük meg jól (ugyanakkor ne feledjük, hogy ilyen plusz-jel alakú őskori-ókori istennő-ábrázolásokat is láttunk, például Michelangelo Naddeo-nál; ez pedig a Nap = [[T/Test\|test]]; alak, [[F/Figure\|figure]] összefüggését is feltárja).  
![assets/NapMAIN_image7.png|fix_dark fix_light](/img/user/N/assets/NapMAIN_image7.png)  
...
<!--section: 17.1-->
János Jelenések könyvének [12. fejezetében](https://web.archive.org/web/20241226091419/https://abibliamindenkie.hu/uj/REV/12/) találjuk:  
...
![assets/NapMAIN_image9.jpeg|fix_dark fix_light](/img/user/N/assets/NapMAIN_image9.jpeg)  
...
A radnóti református templom 1486-ban épült szentélye egyik zárókövén csillagot és Holdat látunk, mégpedig ugyanolyan elhelyezésben, mint ahogyan a székelyderzsi székely címerben, írja Szekeres Attila István Székely jelképek című kis könyvében. Lásd a csatolt képet.
...
![assets/NapMAIN_image15.jpeg|fix_dark fix_light](/img/user/N/assets/NapMAIN_image15.jpeg)  
...
![assets/NapMAIN_image18.jpeg|fix_dark fix_light](/img/user/N/assets/NapMAIN_image18.jpeg)  
...
> Tisztán a középkori szellemben fogant Jézus [[J/Jászol\|jászol]]-szalmaágyának sugaras mandorlaként való értelmezése. A kép a napistenhit hatásának következménye: a téli napfordulatkor a tejúthasadék, az anyai [[O/Öl\|öl]] – erre utal a fénykoszorú mandula formája – a születő napgyermek fényébe öltözik. A "fényébe öltözés" tehát azt jelenti, hogy a Nap éppen ott tartózkodik, ahogy a nyári napfordulókor Orionban tartózkodik.  

[[A/Annual\|Annual]] címnél hasonló passzus szerepelt, csak nem az öltözés kifejezés kerül elő:  
Ami az [[A/Anna\|Anna]] ünnep dátumát ([[J/Július 26\|július 26]].), Szent Anna feltételezett halála napját illeti, itt megint csak Szíriuszra való utalás történik. Ahogy Jankovics Marcell másutt, Pantaleonról (ünnepnapja július 27.) szóló fejezetében írja (a két ünnepnap közt egyetlen nap az eltérés!), napja abba az időszakba esik, amikor a [[S/Szíriusz\|Szíriusz]] távol van, "halott": **fénye belevész a Nap fényébe**.  

Figyeljük meg még azt, hogy a hetedik [[U/Újhold\|újhold]] és az első újhold között éppen (csak szoláris naptári gondolkozás szerint?) [[F/Félév\|félév]]nyi a különbség, mely [[F/Félév\|félév]]ek "[[S/Szíriusz\|Szíriusz]] irányítása" alatt állnak.  
Másrészről tehát az a feltevés, hogy itt egy olyan kép rajzolódik ki szemünk előtt, melynek megoldása a [[S/Szűz csillagkép\|Szűz csillagkép]] (és [[S/Sothic\|Sothic]]) címnél írottak alapján érthető meg (merthogy az [[A/Augusztus 15\|augusztus 15]]. utáni újholdon, szeptember 1.-én kezdődött a naptári év), mégis téves, hacsak nem kell számolni itt a(zzal a) [[P/Precesszió\|precesszió]]val (ami ugyebár a Szíriuszra nem hatna). Hiszen Egyiptomban is a Kutyával kezdték a (viszont szoláris) évet és mégis a (holdnaptárban fontos?) Szűz (jegy) nevéhez látszik illeszkedni [[S/Sothis\|Sothis]] (és Thot hónapja is). Márpedig itt van két jegyes elcsúszás, július 1. és szeptember 1. között.  
Egyébként Z. Tóth Csaba Tropikus vagy sziderikus című cikkében a Napba öltözött asszonyt maga is a [[S/Szűz csillagkép\|Szűz csillagkép]]pel azonosítva említi futólag. (A témáról lásd még [[C/Csillagászat – tropikus kontra sziderikus\|csillagászat – tropikus kontra sziderikus]].)  
Szumma szummárum, úgy tűnik, a Napba öltözés és annak eredeti ünnepköre mintha egy régi, az évet Kutyával kezdődő évkör első újholdjára (ha nem is napfogyatkozásra) utalna.  
Ráadásul ebben az esetben is állna az, hogy a [[B/Boldogasszony\|Boldogasszony]] nevében szereplő Bol-Dog a Szíriuszra utal.  

[[S/Suhurmasku\|Suhurmasku]] és [[S/Szarvas\|szarvas]] címnél sorra vettük az összefüggéseket. Adott Suhurmas(ku), amely szarvas, és adott a [[D/Dream\|dream]] címnél taglalt Dar-Mah, mely szintén szarvas (úgy jön létre, mint [[D/Dragon\|dragon]]), továbbá adott a perzsa `sarmá` = tél, a Szíriusz ind [[S/Sarama\|Sarama]] neve, melyek mind összefüggenek, ha nem is úgy, hogy mind azonos alakként kezelendő, de a téridőbeli elrendezés (téli napforduló, Szíriusz együttállás) illetve kontextus stimmel. A [[C/Csudaszarvas\|Csudaszarvas]] agancsai között hordja a Napot. Nyilván ez a kép az, amely megjelenik [[T/Turul#Turul és Csodaszarvas\|Turul és Csodaszarvas]] cím/alcímnél és ez a kép az, amely itt fentebb is szerepelt. Ha már asszony, tudjuk, hogy az [[A/Asszony\|asszony]] = [[A/Állat\|állat]] (asszonyállat), azaz a Boldogasszony = Csudaszarvas, mely homlokán nem Vénusz, hanem Szíriusz van. Az a Szíriusz, mely téli napfordulós együttállásával és Napgyermek ([[M/Magor\|Magor]]) szülésével adja ki Boldogasszony Bol-Dog nevét/értelmét.  

Szumma szummárum (2), a Napba öltözése az Istennőnek több analógiát társít. Egyszer van egy Nap születés, karácsonykor, mely Gyárfás Ágnes szerint is az az időpont, amikor az istenanya Boldog (ő [[S/Szíriusz\|Szíriusz]] január elsejei delelését adja meg ennek időpontjaként[^11], viszont Bobula Idánál is a karácsony és újév egy és ugyanazon nap kellett legyen régen). Tehát a Szíriuszhoz képesti helyzet leírásáról is van szó, és ez adja meg a [[B/Boldogasszony\|Boldogasszony]] nevezet értelmét is. Mivel fentebb a Hold is előjött, talán nem lehetetlen, hogy [[U/Újhold\|újhold]] vagy [[T/Telihold\|telihold]] jelenség is társul az ünnephez, hiszen tudjuk, hogy ma is figyelembe veszik egyes keleti naptárak újévszámításaikor (holdújévek).  
A Hold kapcsán vajon a telihold (melyről [[A/Augusztus 15\|augusztus 15]]. címnél is volt szó) kapcsolható-e a [[F/Full\|full]] fogalmához (mely full nyilván azonos Bol-Dog szavunk előtagjával)? Vagy a full fogalma azt jelenti, hogy teljes, azaz [[S/Szűz\|szűz]] a Boldogasszony (azaz még [[K/Kisasszony\|Kisasszony]])? Ezeket is tisztázni kéne. Rengeteg dolog marad tisztázandó.  

[[N/Ninhursag\|Ninhursag]] neve kapcsán használja Péterfai János a kifejezést:  
> Nin-Hur-Szág is En-Ki feleségének a neve, a nevet "Hegycsúcs Úrnője" formában értelmezik. A Ninről szóltunk, a Hur a Kur változata akar lenni, Hegy értelemben. A Szág, mint Főség jelenthetné a csúcsot, ezért a Hur-Szág a Hegy-Fősége, amit pontatlanul Hegy-Csúcsnak értelmeznek. Megjegyzendő, a Hur szónak több jelentése is van. A Húr az Íj Ívének az Ura, az Úr pedig gyakran Nap. Továbbá a Csillag-Húr, Bél-Húr nevekben a Húr kifejezetten Napot jelent. Nin-Hur-Szág eszerint olyan Néni, aki Nap-Főség. Talán ő az egyik Napba Öltözött Asszony.  

Vajon ő érti-e valójában, mit is jelent a kifejezés? Ninhursag-ról megállapítottam, hogy a második két tag (Menny)Országot jelent. A hegy értelemmel lehetne éppen számolni, ha az [[A/Ahet\|ahet]] címnél álló fényhegyeket és a [[S/Szümplegádok\|szümplegádok]]at vesszük figyelembe. Az ott írottak szerint is a téli napfordulós szülésről/születésről van szó.  
...
Mondhatni. [[V/Vega\|Vega]] címnél írja az illető (azon csillagképek valóban ott láthatók mindig, ahogy a Göncölszekerek északon):  
> A "Nagy nyári háromszög" csillagai közt vonul át a Tejút (nálunk látható), amely a déli látóhatáron, a Skorpió és Nyilazó közt látszik a legfényesebbnek.  

![assets/NapMAIN_image19.png|invert_light|840](/img/user/N/assets/NapMAIN_image19.png)  
[Ezen](https://www.cpreavonandbristol.org.uk/news/february-star-maps/) oldalon a csillagtérképeket nézve jöttem rá, miért hívja Orion tájékát délinek mindenki: azért mert az északi féltekén éjszaka csak akkor látható, ha télen dél felé fordulunk: azaz a déli égbolton látszik, a Földről nézve (nyáron hiába is keresnénk éjszaka, mert akkor a Nap jár benne). A mellékelt képen, egy februári állását látjuk a csillagképeknek.  
Én pedig **azért hívom északinak, mert a csillagjegyekben járó Nap pozícióját, nem a 6 hónappal előtti/utáni állapotot**, valamint a sötét félévet nyitó kezdőpozíciót (Ikrek-Rák) veszem figyelembe.  

Hasonló esetet látunk a gízai nagy piramis északi és déli járataiból nézhető csillagképek alapján. Az általam [[S/Szíriusz és a medvék\|Szíriusz és a medvék]] és más (lásd temérdek példával [[S/Sacchar-\|sacchar-]]) címnél is északinak vett Szíriusz+Orion a Robert Bauval The Orion Mystery című könyvében is bemutatott képen délinek jelölt (épp a cirkumpoláris, Egyiptomban a horizonthoz egészen közel simuló csillagképekre irányított járat ellentétes oldalán; lásd csatolt képet).  
![assets/NapMAIN_image20.jpeg|fix_dark fix_light|840](/img/user/N/assets/NapMAIN_image20.jpeg)  

[[E/Észak#Kétféle észak\|Kétféle észak]] cím/alcímnél is ezen példa kapcsán leírtam közben, hogy Szíriusz északisága a Sarkcsillag északiságához mérten abban áll, hogy mindkettő egy fenti, legfelső pontra utal és a fent az észak, csak előbbi a későbbi szoláris, utóbbi a korábbi poláris felfogásban volt fontos.  
Ugyanakkor [[U/Ursa Maior\|Ursa Maior]] címnél (képpel együtt) azt láttuk, hogy a Nagy Medve annak az Oroszlán csillagképnek a cikkelyébe tartozik, mely állatnevek között is átfedés fedezhető fel. Az Oroszlán akkor a Földről nézve is északinak tekintendő, így Orion és Szíriusz is.  

Korábban itt álló adatsor:  
[[G/Galactic anticentre\|Galactic anticentre]] címnél és [ezen](https://en.wikipedia.org/wiki/Galactic_coordinate_system) oldalon írottak alapján úgy tűnik, hogy az egyes csillagképek irányát az határozza meg, hogy mi a központ: a Tejútközpont a központ, ehhez mértek, Herschel óta. Ezek alapján a galaktikus észak a [[C/Coma Berenice csillagkép\|Coma Berenice csillagkép]] iránya (amely Lewis Freemantle The Thirteenth Stone című könyvében a Szűzzel együtt olyan fontos jelentőségűnek volt meghatározva), a galaktikus dél pedig azon Sculptor azaz Szobrász csillagkép irányában van (úgy kell elképzelni, hogy a [[C/Cet csillagkép\|Cet csillagkép]] és a [[V/Vízöntő csillagkép\|Vízöntő csillagkép]] között-alatt helyezkedik el), melynek Wiki oldalán is azt írják, hogy a "déli égbolt csillagképe."  

Másutt, [[G/Galactic centre\|Galactic centre]], [[D/Dzsed\|dzsed]] és más címnél szerepeltek adatok innen-onnan arra nézve, hogy mely irányokban találhatók az egyes csillagképek. Ugyebár az ég a Földhöz képest (24 óra alatt el)forog, így mikor kell őket ilyen vagy olyan irányban állónak tartani?  
És persze az sem mindegy, melyik féltekén vagyunk. John M. Jenkins viszont amikor a Tejútközpont irányával kapcsolatosan az alábbiakat írja, akkor a referenciapontnak meghatározott helyet délinek mondja:  
...
> —  
> A Tejútközpont a déli égboltnak felel meg, és különleges rokonságban áll a déli féltekével. Valójában az északi félteke szemszögéből nézve a Tejútközpont mindig a déli égbolton ível át, és a legnagyobb magassága a meridiánon való átvonulásakor az egyén megfigyelési szélességéhez kapcsolódik. Minél délebbre van, annál nagyobb lesz a magassága, amikor áthalad a déli meridiánon (közvetlenül délre, az Északi-sarkkal szemben).  

John Major Jenkins Galactic Alignment című könyvének 158. oldalán a [[S/Szikla\|szikla]] címnél is taglalt [[S/Szümplegádok\|szümplegádok]]at viszont Coomaraswamy adatát követve északi kapura vonatkozó helyre értve hozza (annak meg a Nyilasban kell lennie).  

Például Lewis Freemantle The Thirteenth Stone című könyvében is megad irányokat:  
> The Shi Tenno were spirit beasts who guarded the cardinal points of the temple: the dragon (sun) sat to the east and the black tortoise (Scorpio) to the north; the red bird (Aquarius) guarded the south and the white (albino) tiger (a cat) kept watch over the west – Coma.  
> —  
> A Shi Tenno szellemállatok voltak, akik a templom kardinális pontjait őrizték: a sárkány (Nap) keleten ült, a fekete teknős (Skorpió) északon; a vörös madár (Vízöntő) a délit őrizte, a fehér (albínó) tigris (macska) pedig a nyugatot – [[C/Coma Berenice csillagkép\|Coma Berenice]].  

[[F/Fomalhaut\|Fomalhaut]] kapcsán előjött már, hogy déli, illetve Nyilas kapcsán is, John M. Jenkins tollából ez meg az. A Nyilassal szemközti Szíriusz [[E/Észak\|észak]] (és főleg [[S/Szíriusz és a medvék\|Szíriusz és a medvék]]) címnél írottak alapján is északinak felel meg. [[G/Galactic centre\|Galactic centre]] és [[G/Galactic anticentre\|Galactic anticentre]] címnél álltak John M. Jenkins adatok erről.  
- [[P/Poláris-szoláris átállás#^vuj7s6\|Poláris-szoláris átállás]] címnél is szó esett az észak-déli felfogásról.

Ugyanakkor [[S/Szíriusz és a medvék\|Szíriusz és a medvék]] címnél arról is volt szó, hogy nem igazán lehet tudni, mi mire utal és milyen összefüggésekkel kell számolni. Ott van például a [[K/Kantár\|kantár]] címnél is taglalt [[H/Hunter\|hunter]] esete, mely [[C/Centre\|centre]] = központ olvasatán keresztül és a török [[K/Kuntar\|kuntar]] = kampó szó értelmén keresztül ezek szerint a déli kampóra, fúrócsillagra utal, míg a [[C/Compass\|compass]] címnél említett litván `kampas` = szög az északi kampóra utal (ezen szavakban még a finn [[S/Szampó\|Szampó]] malom nevét is kiolvassuk). De ha az északi sarkhoz képest Szíriusz (és Canopus) délen van, akkor az azzal szemben lévő Tejútközpont merre van? Hiszen az egész rendszer forog.  
![assets/NapMAIN_image21.jpeg|invert_light](/img/user/N/assets/NapMAIN_image21.jpeg)  
Az eredeti [alábbi](https://www.youtube.com/watch?v=V67qv9QbkPg) Jézuspasszport – Az Időkód II. c. videóban 4:15-nél mutat képet ([[S/Szíriusz mozgása\|Szíriusz mozgása]] címnél is szerepelt), ahol szintén déli irányban van feltüntetve Szíriusz. A másik csillag baloldalt nyilván a [[S/Sarkcsillag\|Sarkcsillag]], míg maga a piramis felfogható a [[V/Világhegy\|Világhegy]]en kívül a világtengelynek, illetve a libikóka központi felfüggesztési pontjának.  

És akkor még nem beszéltünk arról, amiről szintén [[S/Szíriusz és a medvék\|Szíriusz és a medvék]] címnél is tettem említést: mi van, ha a Föld ma fejjel lefelé van (és nem a Tejútfa, ahogy [[D/Dzsed\|dzsed]] címnél írtunk hasonlókról) és régen a Szíriusz volt a fejünk felett északon?  
...
Szintén északinak mondja...

<!--section: 24-->
#### Greg Rigby The God Secret...

<!--section: 24.1-->
...című könyvében az alábbi csillagképeket:  
> It is possible, that [[C/Cernunnos\|Cernunnos]] and the various animals is a stylized depiction of the northern star constellations (Draco, Leo Minor, Leo Major, Lynx, Canis etc...) that are adjacent to Ursa Major and rotate around the Northern Pole position.  
> —  
> Lehetséges, hogy a [[C/Cernunnos\|Cernunnos]] és a különböző állatok az Ursa Major melletti, az Északi-sark pozíciója körül forgó északi csillagképek (Draco, Leo Minor, Leo Major, Lynx, Canis stb...) stilizált ábrázolása.  

Az interneten is több forrás szerint az Ikrek a legészakibb csillagkép, így a Nyilas a legdélibb kell legyen. Ennek értelmében is [[D/Dél\|dél]] = [[T/Tél\|tél]]. Erről lesz lentebb is szó, viszont ennek ellentmond Jankovics Marcell alábbi passzusa:  
> Az archaikus gondolkodásban a nyárhoz a [[D/Dél\|dél]] (napszak és égtáj; [[S/Summer\|summer]] is így lehet sumér?), a [[T/Tűz\|tűz]] (elem), a színek közül többnyire a sárga rendelődött.  
- A dél mint napszak stimmel, de az égtáj kapcsán gondjaink származnak.
...
- Már csak ez alapján is a déli irány a vulva, a Nyilas/Nyílás csillagkép iránya kell legyen.

Az észak pedig ma fentnek felel meg. Ennek ellenére a déli/téli napfordulós Tejútközpont kapcsán Jankovics Marcell hogy fejezi ki magát egy helyütt: A születés barlangja a téli napforduló égi helye, a felső tejúthasadék. \[??? Ezt úgy fogalmazta, mintha kettő lenne?\]  

Ahogy viszont [[P/Pabilsag\|Pabilsag]]-ot a sumérok rosszul értelmezték, és [[O/Orion#Orion mint Nyilas/Vadász – Orion/Aryan és Pabilsag problematika\|Orion mint Nyilas/Vadász – Orion/Aryan és Pabilsag problematika]] cím/alcímnél is hibás következtetéseket levonó magyar kutatók adatai jelentek meg, úgy látszik megjelenni hibás felfogás arról is, hogy mi számít északinak és délinek (de már [[B/Bal és jobb\|bal és jobb]] címnél is bőven taglaltuk azon problematikát, hogy melyik a bal és jobb oldal, illetve [[H/Hunor és Magor#Hunor és Magor azaz inkább hunok és magyarok életköri szerepeinek ellentmondásai\|Hunor és Magor azaz inkább hunok és magyarok életköri szerepeinek ellentmondásai]] cím/alcímnél is taglaltuk az elentmondásokat).  

Például [[I/Irán és Turán\|Irán és Turán]] címnél Bobula Ida The Great Stag című dolgozatában (melynek magyar fordításából idézek) is nála délinek az minősül, ami nálam észak:  
Turán lett később a föld, amit az Északi Égbolt borít, a Bak ege, szemben Iránnal, amit a déli ég borít (URAN), az Oroszlán ege. ([[U/UR\|UR]] címnél írottak alapján jött elő vajon az Oroszlán?)  
Annyiban igaza van, [[E/Észak\|észak]] kapcsán, hogy az észak és az ősanyaistennőhöz ([[T/Turán\|Turán]] valóban megjelenik istennőként is, igaz Földistennőként, és Bobula Ida is úgy fogalmaz, hogy csak később lett földre vonatkoztatott, ahogy az égről földre tükrözés értelme is ezt mutatja) tartozó sötét ([[S/Széth\|Széth]] is az eredeti isten; lásd még [[S/SZET\|SZET]] és [[S/Sátán\|Sátán]]) a régi, csillagvallást vallók által tisztelt.  
[[T/Throne\|Throne]] címnél írtuk, hogy nemcsak Torony, de Turán is megfelelő név mögé. A trónus istennői trónus és az égen is megtalálható. Ott volt szó Várkonyi Nándor [[V/Világhegy\|Világhegy]] címnél álló, Vámos Ferencre építő adatáról, ahol előjön egy trón-, azaz torony-csillag (vagy a [[S/Sarkcsillag\|Sarkcsillag]] vagy a [[S/Szíriusz\|Szíriusz]]), mely Torony-Trón tehát [[T/Turán\|Turán]] értelmét is adhatja, utalva a turáni népek csillagvallására, szemben az iráni népek későbbi napvallására (igaz, Turán-nak is lehet napgyermekre utaló jelentése).  
Jankovics Marcell Jelkép-kalendárium című könyvének 175. oldalán írottak viszont ismét zavaróak, mert a fentiek alapján északinak mondott Orion-Szíriusz itt déliként jön elő:  
> Egyiptomon az óbirodalom idején egy **iker**istenpár uralkodott, mint Felső- és Alsó-Egyiptomnak, az **emelkedő és a hanyatló Nap félesztendejé**nek ura, illetve az [[O/Orion\|Orion]] és a [[G/Göncöl\|Göncöl]] csillagzat képében mint a déli és az északi égbolt királya: Ozirisz és a szamárfülűnek mondott, máskor az "Ég Bikájának" nevezett [[S/Széth\|Széth]].  
- A két Egyiptom Magaru és Hun nevei is ilyen égi tagolásra utalnak.

Nem tartozna össze [[S/Szíriusz és a Sarkcsillag\|Szíriusz és a Sarkcsillag]], ahogy gondoltam? Végül is, de, csak az egyik ezek szerint dél, a másik észak. Nem erről van szó. Két külön tengelyről van szó, ahogy erről szóltunk már.  

Viszont akkor hogy lehet a Skorpió északi? És akkor hogy lehet a Vizöntő déli, mikor ezen jegyek nem egymással szemben állnak egymással?  

A [[D/Dél\|dél]]i = [[T/Tél\|tél]]i lenne? Így is vagy pontosabban: csak így értelmezhető a kérdés? Nyilván ezek alapján ([[K/Kelet és nyugat\|kelet és nyugat]] és [[B/Bal és jobb\|bal és jobb]] címnél álló adatok alapján) igen:  
A nyári napfordulón, fénymaximum idején kel legészakabbra és a téli napfordulón, a fényminimum idején a legdélebbre a Nap.  
Amint a Nap egyre északabbra vándorol az ekliptika mentén, március 21.-én eléri az ekliptika és az égi egyenlítő metszéspontját, amelyet [[T/Tavaszpont\|tavaszpont]]nak nevezünk (délebbre vándorlásával pedig szeptember 23-án az [[O/Őszpont\|őszpont]]ra jut).  
A [[B/Bal és jobb\|bal és jobb]] címnél is szereplő, René Guénon Lord of the World c. könyvéből származó passzusában:  

<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/U/Uttara/#555fs6" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">
...
Ugyanakkor ahogy Jankovics Marcell másutt írja, az archaikus gondolkodásban a [[N/Nyár\|nyár]]hoz a [[D/Dél\|dél]] (napszak és égtáj\[?\]; [[S/Summer\|summer]] is így lehet sumér?), a [[T/Tűz\|tűz]] (elem), a színek közül többnyire a sárga rendelődött.  

Az efféle infókat szeretném még egy helyen gyűjteni (Jankovics Marcell Ahol a madár se jár című könyvében írja):  
> Az uráli népek északi lakhelyüknél fogva, ahol a [[S/Sarkcsillag\|Sarkcsillag]] a zenithez közel ragyog, **az ekliptika pedig alig válik el a horizonttól**, az eget alulnézetben ábrázolták. Dobjaik olyan egyszerűsített égtérképként írhatók le, melyek az északi égboltot a látvány, a délit az ellentétpárokra épülő gondolkodásmódnak megfelelően annak tükörképeként jelenítik meg. (Ezzel szemben, a tőlük délebbre lakó altaji népek az eget oldalnézetben ábrázolták.)  

Az, hogy a Nap keleti, azt jelenti, hogy minden esetben a kelő Nap irányához képest kell a többi csillag és a [[T/Tejút\|Tejút]][^12] irányát is figyelembe venni? Ezt kellene csillagásztól vagy a neten valakitől megkérdezni (bár gyanítom, Jankovics Marcell vagy John M. Jenkins könyvében már a magyarázat valahol elhangzott).  
A [[T/Tejút\|Tejút]] különböző állásairól volt szó ott.  
[[K/Karácsony\|Karácsony]] címnél volt szó még a Tejútfa függőleges helyzetéről.  
Nem könnyű a csillagképek irányát (ahogy a Tejút helyzetét sem; lásd például [[K/Karácsony\|Karácsony]]) meghatározni, hiszen a napi időciklusban is változik, de a többiben is.  
Annyit tudunk például [[S/Szíriusz\|Szíriusz]]ról, hogy nyáron és télen tőlünk keletre van, ilyenkor vannak az együttállások is.  

<!--section: 25-->
#### Jankovics Marcell Jelkép-kalendárium...

<!--section: 25.1-->
...című könyvében még ezt írja (de persze az alvilág másutt dél; emlékezzünk William F. Warren könyvére):  
> A fekete víz – költői szövegekben olaj – az alvilági vizeket jelképezi; rejtett értelme szerint a Nagy Istennő magzatvize ez, melyben a hamarosan újjászülető Nap éli magzati életét. Egyetemes képzet szerint az [[A/Alvilág\|alvilág]] északon van – [[E/Észak\|észak]] régen azonos volt a "lent" fogalmával –, s ott örökös éjszaka honol. (Az alvilági lejáratot viszont sok rege nyugatra helyezi. Ennek oka, hogy a Nap nyugaton nyugszik, s a "lejárat" égi helye, a Nyilas és a Skorpió csillagkép időszámításunk előtt még "nyugati", azaz őszi csillagkép volt.)  

<!--section: 26-->
#### John G. Jackson Christianity before Christ...  

<!--section: 26.1-->
...című könyvének 145. oldalán egyiptomi csillagképek kapcsán bemutatott adatai szerint így festett számukra a kép (viszont Egyiptom kapcsán jegyezzük meg hogy náluk sok minden fordítva volt) (én itt már magyar fordításban adom):   

> ### Ősi Iránytűistenek
> 
> | Nevek       | Szimbólumok | Irányok | Színek | Évszakok |
> |-------------|-------------|---------|--------|----------|
> | Amset       | Ember       | Észak   | Piros  | Tél      |
> | Tuamutef    | Sakál       | Kelet   | Fehér  | Tavasz   |
> | Gebhsenunef | Sólyom      | Nyugat  | Fehér  | Ősz      |
> | Hapi        | Majom       | Dél     | Zöld   | Nyár     |
> 
> ### Állatövi megfelelőik
> 
> | Nevek    | Szimbólumok | Helyszínek          | Irányok |
> |----------|-------------|---------------------|---------|
> | Vízöntő  | Vízhordó    | Téli napforduló     | Észak   |
> | Bika     | Bika        | Tavaszi napéjegyenlőség | Kelet   |
> | Skorpió  | Skorpió     | Őszi napéjegyenlőség | Nyugat  |
> | Oroszlán | Oroszlán    | Nyári napforduló    | Dél     |

Lásd még [[E/Észak#északi és déli csillagképek\|északi és déli csillagképek]] cím/alcímnél írottakat.  
...
Magyar Adorján A lelkiismeret aranytükre c. könyvének első lapján szereplő adata szerint a jászok [[J/Jász\|Jász]], Jázon vagy Jázzú neveken is nevezték a Napistent. Ugyanakkor lentebb látjuk majd, hogy nyilas voltuk miatt (is) ugyanazon néven nevezhető Nap és Orion, ahogy a besenyő Nap és Orion [[P/Pater\|Pater]], Peter, Beszer, [[V/Vezér\|Vezér]] neveken osztoznak ([[V/Vezér#Vezér mint Nap(isten) vagy Orion (Isten) – Ozirisz sem más mint Nap az Orionban\|Vezér mint Nap(isten) vagy Orion (Isten) – Ozirisz sem más mint Nap az Orionban]] cím/alcímnél írottakat is lásd).

A [[S/Székely\|székely]] és [[S/Sacchar-\|sacchar-]] címnél is említett, Magyar Adorján által napistennévként megadott Zakur szintén Orion (és Kutyás) értelmezést visz még. De Magyar Adorjánnál [[K/Kazár\|kazár]] is Napnév, mely szintén Orionnal hozatott kapcsolatba nálam.  

(Viszont ahogy [[B/Balta\|balta]] és [[P/Pálca\|pálca]] címnél is láttuk, a palóc Napisten Balota a névadó. Viszont hasonló név megjelenhet Orion neveként is. Van ilyen? Igen, [[B/Balog\|Balog]].)  

[[H/Hunor és Magor#Hunor és Magor azaz inkább hunok és magyarok életköri szerepeinek ellentmondásai\|Hunor és Magor azaz inkább hunok és magyarok életköri szerepeinek ellentmondásai]] cím/alcímnél is írtuk:  
A Fiatal Nap jelentésű, Jézushoz hasonlóan barlangban, a téli napfordulón születő [[M/Mithra\|Mithra]] (akár mint Mithrász) csillag(kép)teste hogy lehet Orion? (Mithras már mint európai \[Rómában kultikussá vált\] istenség nem is nap-, hanem az Orion csillagkép és a Nap együttállását megszemélyesítő isten volt, írja Jankovics Marcell.)  

Különösen azon Nap és Orion ábrázolások és a hozzájuk köthető jelvények-attribútumok (testtartások, eszközök (például pásztorbot, jogar), fegyverek; lásd Orion kapcsán például [[B/Bál\|Bál]], [[S/Sah\|Sahu]] és [[P/Papszukkal\|Papsukkal]]) érdekesek, melyekben az égi/isteni hatalom kifejeződik. Mondhatnánk, amilyen apja, olyan a fia (hímségi, szexuális tartalmú a kard és a nyílvessző is), de elég sajátos a helyzet. Már [[O/Orion\|Orion]] (és [[I/Isten\|Isten]]) címnél is megfogalmaztuk, hogy az ő antropomorfizált alakja mintha az ember képére volna mintázva, ugyanakkor az ember pedig Orion fiáról, a Napról mintáztatik, hisz a [[N/Nép\|nép]] szó is ezt mutatja. Sajátos helyzet. Azt tudjuk, hogy a finnugor mitológiában is szereplő Világügyelő férfi[^14] nem más, mint a Nap (Arany Atyácska a másik ismert neve), azaz ezen megszemélyesítés (hogy [[K/Krishna\|Krishna]] és [[J/Jézus\|Jézus]] neveit ne is említsük) az embertől indul ki, visszavonatkoztatva.  

(A teljes isteni-emberi viszonyrendszer felvázolva: Tejútanya, kinek fia a Nap és azok népei az emberek (egyes csoportjai, különböző törzsi- és népneveken), de apaszerepben Tejútanya/[[S/Szíriusz mint istenanya\|Szíriusz mint istenanya]] férje Orion (annak is az övcsillagai érdekesek) (kimondható, hogy [[S/Szíriusz\|Szíriusz]] egyszerre nőiségi és hímségi, hisz a – [[S/Száj\|száj]]on általi – nemzés ott megy végbe, és a szülés helye lesz más, a szemközti Nyilasban; ez a [[S/Szeplőtelen fogantatás\|szeplőtelen fogantatás]] csillagászati háttere).  

A fentiek [[M/Magyar istencsalád\|magyar istencsalád]] címnél szebben ki lettek dolgozva.  

Az [alábbi](https://qr.ae/TZfXT8) Quora kérdésre adott válaszomban is kitértem arra, hogy [[M/Mózes\|Mózes]] születése Nap-karakterére utal, majd idősebb korában, amikor a Nap az Orionba ér, vele mondhatni egykorú, öreg \[már Hunor = Hunter = Orion\] lesz. Hasonló eset fordul elő [[I/Izmael\|Izmael]]lel. Magor a fiatal Nap és Hunor mint Orion az idős.  
![assets/NapMAIN_image23.png|fix_dark fix_light](/img/user/N/assets/NapMAIN_image23.png)  
Jankovics Marcell több adata szerepelt már itt-ott (fentebb is) arról, hogy amikor a Nap a [[N/Nyári napforduló\|nyári napforduló]]kor Orionban tartózkodik, akkor veszi fel annak hatalmát, azaz akkor lehet a Nap, akár mint [[M/Mithra\|Mithra]], [[V/Väinämöinen\|Väinämöinen]] és mások (ahogy Mózes) Orion is. (Ugyanakkor Mithra nevének értelmezése szerint ugyanolyan téli napfordulón születető Nap, mint [[M/Magor\|Magor]] és [[J/Jézus\|Jézus]]. [[K/Krishna\|Krishna]] fekete értelmezésével pedig mit kezdjünk?)  
![assets/NapMAIN_image24.png|fix_dark fix_light](/img/user/N/assets/NapMAIN_image24.png)  
Orion ábrázolások előfordulnak nyíllal, karddal és bunkóval is, ugyanígy a Nap lehet bottal, bunkóval, kalapáccsal szerelt, és szárnyas [[N/Napmadár\|Napmadár]]ként kap nyilas ábrázolásokat ([[N/Napvallás\|Napvallás]] címnél több kép van szárnyas Napról), már amennyire a Martin Klingbeil Yahweh Fighting from Heaven című könyvének 197. oldalán taglalt, mellékelt új-asszír ábrázoláson az alant még említett [[S/Samas\|Samash]]-t és nem [[A/Asszúr\|Asszúr]]t látjuk (Klingbeil szerint előbbit, egyszerre karddal és íjjal). A másik mellékelt [[A/Asera\|asera]] címnél is szereplő képen állítólag Assur látható, és könnyebben kivehető az íja.  
  

Az íjjal szerelt Napistenek mind arra utalnak, hogy amikor a Nap elér az Orion csillagképhez (pontosabban a nyári napfordulóhoz), ott lesz egy ív (egy szög, hajlás, a napforduló), és mivel ez a hely választja el világos és sötét félévet, Jupiter és Szaturnusznak megfelelő istenségek is ábrázoltathatnak nyilazókként, ahogy erről [[K/Kámán\|Kámán]] címnél is tettünk említést.  

Az iménti információval fel nem vértezett szemlélődő számára az íj ugye inkább Orionnál egyértelmű, mely egyrészt a [[P/Pleiadok\|Plejádok]] felé (Gyárfás Ágnes szerint a Tejútközpont felé) mutat (korábbi, más felfogás szerint a nyila Szíriuszra mutat).  
Ugyanakkor Gyárfás Ágnes és mások írásában is előjön Orion karddal vagy bunkóval "szerelve." Legutóbb [[K/Kovács\|kovács]] címnél szóltunk arról, hogy a kard a kovács által készített és a kalapács (mely például [[T/Thor\|Thor]] égisten attribútuma) az ő szerszáma. Az égi kovácsot is Orionnal feleltettük meg. Az alábbi Magyar Adorján passzus pedig jól rávilágít, hogy a kovács az, aki a kalapácsával a villámot és a dörgést idézi elő:  
> Ami pedig a [[D/Damaszkusz\|Damaszkusz]] városát illeti, régibb nevei Tamaszku és Damasek voltak. Márpedig Damaszkusz épen kovácsairól volt híres, különösen pedig fegyverkovácsairól és a damaszkuszi dömöckölt kardpengékről; mi pedig tudjuk, hogy régi nyelvünkben a mai ö hang helyett gyakran u ejtődött. De mi már tudjuk azt is, hogy az m hang mily könnyen váltakozhat az n hanggal. Ezt tudva pedig eszünkbe kell jusson az is, hogy a latinban `tonitru`, az olaszban `tuono`, az angolban [[T/Thunder\|thunder]], a németben `Donner` = menydörgés, továbbá, hogy a germán mythologiában is Donar, máskép Tor a villám és menydörgés istensége neve, akit pedig rettenetes kalapáccsal kezében képzeltek.  
- Mivel a kovács Orionnal azonosított, ezért [[T/Thor\|Thor]] is Orion kell legyen. Lényegében Thor nem más, mint Úr t-előhangos változata.  
Magyar Adorján szabálya szerint a hárombetűs név Napnév kellene legyen.  

Lényegében azt kell látni, hogy a Nap is ugyanúgy lehet bunkós, kalapácsos (nyilván innen a sötét féléves bűn Napisten Hunor > [[K/Khamor\|Khamor]] > [[H/Hammer\|hammer]] eredete is), és nyilas ábrázolást kapó, mivel a Nap csillagkép-teste (atyjaként) Orion. Ezért lehet Orion is egyrészt bunkós, kalapácsos égisten, hiszen a régi ember felismerte, a Nap nem lehet felelős a villámlásáért és esőért (lásd [[O/Orion\|Orion]] címnél is volt szó a vízfakasztásról). A régi csillagtérképeken is előjön Orion bunkóval és karddal (viszont [[M/Makar\|Makar]] és [[M/Mace\|mace]] címnél előjön Makar isten fegyvereként is buzogány és kard és éppen magyar/makar alakú szavakkal, melyek talán nem is a készítő népre utalnak, ahogy a Khamor sem, hanem a Napisten marsikus attribútumaira; nyilasként pedig a Merkúr alakul ki a Napból).  
Visszatérve még Thor nevére, ez is egy olyan germán istennév, melynek megvan finnugor ([[N/Numi Tórem\|Numi Tórem]]) és latin ([[N/Numa\|Numa]] és [[N/Numitor\|Numitor]]) párja. Nyilván a turk/[[T/Török\|török]] és [[T/Tárkány\|Tárkány]] (fegyverkovács) nevek összefüggései is mind magyar eredetre mennek vissza.  

Arról, hogy a római Numitor [[R/Romulus és Remus\|Romulus és Remus]] nagyapja, Magyar Adorján szintén Csodaszarvasában írja, a vogul neveket is szóba hozva:  
...
- A Nap és [[N/Nép\|nép]] szavak egyezőségét nem emeli ki, pedig megtehette volna itt; igaz a nép szót nem is használta. Ezen passzus [[M/Magyar istencsalád\|magyar istencsalád]] címnél is szerepelt.

[[P/Papszukkal\|Papszukkal]]t nem bunkóval, hanem bottal ábrázolták, mert [[P/Pásztor\|pásztor]]. Az ezen névhez kapcsolható\[?\] Bazd-Úr fogalma igen hasonló [[N/Nimrud\|Nimrud]] fogalmához (a botok a hímség jelképei ugye) (akihez közben megfeleltettük [[N/Numi Tórem\|Numi Tórem]]et is).  
De ha már pásztor, a [[F/Father\|father]] és [[P/Patron\|patron]] címnél taglalt Pater is lehet Nap-atya vagy Nap-Atyjaként Orion. Pat-Er megfordítása, Er-Pat [[A/Árpád\|Árpád]] olvasatában viszont Napkirály minőségét tekintve inkább Nap. Lásd még alant [[N/Nap#Napatya és Napfiú\|Napatya és Napfiú]] alcímet is.

![assets/NapMAIN_image25.jpeg|fix_dark fix_light](/img/user/N/assets/NapMAIN_image25.jpeg)  
Gavin White Babylonian Star Lore című könyvének [[G/Guanna\|Guanna]] címnél is szereplő képén a jobb oldalon nyilván Sah-[[S/Sah\|Sahu]]-t látjuk, kinek jelvényeit elnézve (Vezér-)[[O/Ozirisz\|Ozirisz]] jelvényei jutnak eszünkbe.  
A Gavin White könyvének adatait feldolgozó Huszárik László Gilgamesről, Enkiduról és denderai zodiákusról szóló ZMTE kiadványokban megjelenő cikkeiben is a sumér és egyiptomi egyezőségeket mutatja be.  
[[S/Samas\|Samas]] nála ugyanolyan alapon neveztetik Orionnak, ahogy [[B/Bál\|Bál]] és mások. [[O/Ozirisz\|Ozirisz]] pedig szintén napistenként Orionnak.  
Persze [[H/Hunor és Magor\|Hunor és Magor]] nevek kapcsán is a napminőségek Orionbani elválasztásáról lehet beszélni (Magor felnőve önmaga apja lesz, amikor Hunorrá válik).  

[[I/Indra\|Indra]] és [[P/Párduc\|párduc]] címnél is taglaltuk azt a problematikát, hogy a pettyesség mire vonatkozhat, de Indra szerepe szerint is inkább Szíriusz-Orion, mintsem Napisten, ahogy a párduc bőre (mint a párduc [[K/Kacagány\|kacagány]]) is égjelkép kell legyen.  
A [[B/Bál\|Bál]]-Nimród összetartozás előjön Péterfai Jánosnál is, de fontosabb talán arra rámutatni, hogy a Nap és Orion miképpen tartozhat össze:  
[[B/Balog\|Balog]] király nevének jelentése Hatalmas Óriás. Egyes nyelvészek szerint Balog "balkezes" lenne, de ez nem királynév, továbbá a magyar nyelvészek nem ismerik sem Bal (Bál), sem Og nevének jelentését. Amint írtam, a Bál név Ragyogó is, Bal-Og ezért lehet Ragyogó Óriás is. Ragyogó Óriás a Nap, vagy a Vadász csillagkép, teljesen egyértelműen, tehát Balog is a Nap földi jelképeként uralkodott.  
[[B/Balog\|Balog]] tehát lehetne a Bál-Orion, mint kovácsisten neve is. Viszont nem szabad kihagyni a Bal-Ug, Bál Fia értelmezést sem.  
[[P/Palóc\|Palóc]] is lehetne Pal-Ug, Bál Fia értelmű (Orion fiára, a Napra utalva, kinek fiai a palóc nép). Azaz látjuk, hogy az Orion és Nap közötti apa-fia viszony nyomán apa = fia (kinek, a Napnak fiai a nép) viszony is kialakul. Ezért teszi nehézzé a [[B/Balog\|Balog]] és [[B/Baluch\|Baluch]] címnél taglalt nevek helyes értelmezését.  
[[M/Magyar istencsalád\|Magyar istencsalád]] címnél is szerepelt, hogy az ősvallás csillagászati hátterű. A család szükségszerűen áll apából, anyából és gyerek(ek)ből. Hogy a gyerek [[M/MAG\|Mag]] = Nap, erről másutt volt szó (még a keltában is mag, [[M/Mac\|mac]] = fiú) illetve arról is, hogy a fiú régen gyerek, sarj értelmű volt. Viszont a csillagmitológiában a lány az anya fiatalabb énjére utal (lásd [[D/Daughter\|daughter]] és [[T/Tündér\|tündér]]), míg a fiú az anya fia, Napgyermeke, kiből felnővén (amikor a Nap a Szíriusszal, Orionnal együtt áll és Hunor-Széth lesz belőle) a szerelmese is lesz ([[I/Incest\|incest]] címnél erről volt szó; ezen a ponton ölheti meg apját, Oriont a Nap, hogy anyját nőül vegye), ami alatt azt kell érteni, hogy a Nap a Tejút körén mozog, semmi mást (anya nem hálhat fiánal a valóságban). A Nap = Orionná válás így érthető meg. Azt kell látni, hogy [[M/Magor\|Magor]] a téli napfordulón megszülető napisten (napminőség) neve, melyből az Orionba érve (annak csillagtestébe öltözve) Hunor (és [[K/Khamor\|Khamor]]: Kám-Úr) lesz. Ezért ír Péterfai János [[H/Hunor csillagkép\|Hunor csillagkép]]ről is, Orionnal azonosítva.  
Ezen a téridőbeli ponton válik Magor Hunorrá, és Hunterré, vadásszá, azaz üzekedni vágyóvá (vágyja a vadat a vadász, ezért jelenti [[N/Nimrud\|Nimrud]] a nemzőrudat és [[K/KÁR\|kár]] = hímtagot és nem vadászt). Na most, figyeljük meg, a teljes, eredeti [[H/Hunter\|hunter]] formából létrejövő [[H/Hunt\|hunt]] azonos a [[H/Haunt\|haunt]] = kísért és [[H/Hound\|hound]] = vadászkutya szavakkal is. Itt válik Magorból Hunor és kutya is, hiszen a Kutya csillagképben történik a nemzés, a [[K/Kutyanemzés\|kutyanemzés]], hiszen a kutya nem más, mint a szexualitás jelképállata (is). (A [[H/Hound\|hound]] formával azonos a [[C/Cunt\|cunt]] is, mely lehet a szuka/emberi nő vaginája, viszont a Tejútanya vulvája pont a Szíriusszal szemben van.)  
...
Ki is az az [[O/Orion\|Orion]]? Nevének értelmezése szerint az Ég Ura. [[A/Anu\|Anu]] címnél is volt arról szó ([[I/Isten\|Isten]] címnél is, ahol sok másról is szó volt), hogy hogyan alakulhatott ki hímségiként kezelése. Azóta legutóbb [[N/Ninsubur\|Ninsubur]] címnél írottak alapján pontosítunk:  
...
Az több helyen elhangzott, hogy a földön a fiúk a Nap (a [[S/Szűzanya\|Szűzanya]] Napfiának) nevét kapják. A Nap nagysága, nagyszerű, ragyogó szerepe elvitathatatlan, de az utóbbi évezredekben felerősödő patriarchalizmusban (mely a [[N/Napvallás\|Napvallás]]ok kialakulásának eredménye, kiteljesedése) a nagyság a hímséggel hozatott kapcsolatba. [[O/Orion\|Orion]] és [[I/Isten\|Isten]] címnél volt szó arról, hogy az ember képmására formálta meg az Istent, egy csillagképben, mely nagyobb mint ő maga: a nagy szinonimája az óriás is (valójában a nagynál is nagyobb). Márpedig figyeljük meg, az olyan nevek, mint [[G/Gábor\|Gábor]], inkább utalnak a Napatya Orionra, mintsem a Napra. Lásd a névről még ott.  

[[R/Rama\|Rama]] címnél arról volt szó, hogy 14 évig testvére Bharata uralkodik helyette. Nyilván a [[N/Nakshatra\|nakshatrá]]k felezéséről, a sötét és világos [[F/Félév\|félév]]re való tagolásról van szó. A kérdés már csak az, hogy Rama vagy Bharata a sötét térfél ura. Ugyanis Rama (kinek szintén íja van) olyanféle alak, akire Nap és Orionként is gondolhatunk.  
[[P/Pán\|Pán]] címnél Magyar Adorján amellett kardoskodik, hogy ez is Napnév. Igen ám, de [[P/Panther\|Panther]] címnél legutóbb írottak szerint (ahol egy maori `panata` = párduc is előjött, éppen olyan alakban, ahogy Magyar Adorján is említett egy ilyen nevet) Pán-Ter nem lehet Nap, hanem annak atyja. Pán-Ter nem más, mint (a sumér [[M/Mul.Pan\|Mul.Ban]]-nal is egyezően) Hun-Ter/Vándor/Nimud-Orion (illetve az övcsillagaiból kiinduló, Szíriusz irányába mutató nyíl- és/vagy hímvessző). Mivel Orion az Ég Ura, és az Ég a mindenség, a görögök jól vették át a [[P/Pán\|Pán]] = minden(ség) értelmű szót.  
A Nap a nyári napfordulóig Nap (ahogy Magor addig Magor), aztán Pánba/Szíriusz-Orionba (a sumér [[M/Mul.Pan\|Mul.Ban]] = Íj/Hunor/Hunter csillagkép) érve Pán lesz belőle, ahogy Magorból Hunor.  
A fordított irányú olvasat tehát azt jelenti, hogy az [[E/Életkör\|életkör]]ben a halál irányába haladunk (a nyári napforduló után a Nap delelő magassága csökken). [[S/Szómegfordítás#Szótagmegfordítás\|Szótagmegfordítás]] címnél sok más példával igazoltuk, hogy az évkör sötét és világos félévei alapján kell gondolkodni.  

Ha már a [[P/Panther\|Panther]] névnél tartunk. [[M/Magor\|Magor]] címnél szó esett a [[M/Macaroni\|macaroni]] bögyörő (vesd még össze mogyoró) értelmével szépen passzolni látszó francia `maquereau` = kerítő (a spanyolban is `macró`) szóról.  
A kerítő téma azért érdekes, mert Lewis Freemantle The Thirteenth Stone című könyvében írottak szerint Chaucer-nál az Orionnal, és így Khamor/Hunor/[[I/Íj csillagkép\|Íj csillagkép]] mentén nemcsak Ámorral, de a [[P/Panther\|Panther]] (és [[P/Panderer\|panderer]]) címnél is említett görög mitológiai Pándaros-szal is megfeleltethető `pandarus` = kerítő jelentéssel megadott, éppen amilyen szerepet játszik Shakespeare Troilus és Cressida című drámájában Pandarus, a kerítő. Azaz amíg a kerítő szerepében előbb Hunort látjuk, furcsamód Magor is megjelenik: Magor ugye az az alak, aki Orionba érve Hunorrá lesz.  

Oláh Imre A Nimrud hagyomány című tanulmányában Jacob Bryant és George Rawlinson alapján írja, és ez [[O/Ozirisz és Széth\|Ozirisz és Széth]] címnél is szerepelt, hogy Ozirisz is Napisten (vegetációs karaktere is erre mutat). Aztán még írja azt is, hogy a Napként azonosított híres tűztisztelő vallásalapító [[Z/Zarathustra\|Zarathustra]], Zarduszt neve is az Ausar, Sar, (SR = Nap) nevéből ered, de érthető is, hiszen a klasszikus történelem, magát Khust – Nimrudot azonosította Zarathusztrával.  
[[N/Ninurta\|Ninurta]] is olyan alak, aki a Nap és Orion (plusz Szaturnusz) elegyének látszik. Lásd róla alant.  
[[H/Hős\|Hős]] és [[O/Ős\|ős]] címnél volt szó legutóbb arról (azon túl, amit ...

<!--section: 28-->
#### Oláh Imre A Nimrud hagyomány...

<!--section: 28.1-->
...című tanulmányában ír a Nimrud isteni ősként/hősként való magyar és más hagyományokból ránk maradt tisztelete kapcsán[^15]), hogy a [[H/Hős\|hős]] nem más, mint az [[O/Ős\|ős]] szavunk hehezetes változata. Nimrud ugye az Orion csillagképben tisztelt ős-hős, míg rendesen a hős a Nap hőjével hozatik kapcsolatba. Úgy is mondhatnánk, hogy a hős az ős fia, ha az ős Nimrud-Orionként az atya (Tejút-Szíriuszként az anya), és annak fiaként a Nap a hős (illetve e mesehős a Nap szerepében).  
[[O/Orion övcsillagai#Orion mint ős (nemzés tekintetében) vagy az ősök háza – hárommal való jelzése\|Orion mint ős (nemzés tekintetében) vagy az ősök háza – hárommal való jelzése]] cím/alcímnél taglaltuk az atyától és anyától való származást, ahol ezen passzuson túl másról is volt szó:  
Azaz itt is azt látjuk, hogy a le[[S/Származás\|származás]], azaz az ember égből, Istentől való származtatásának lépcsőfokaiban a legfőbb ős Isten illetve az ő szerepét megistenített formában bíró Nimrud-Orion; ennek fia a Nap, melynek népe a nemzet, mely emberekből áll. A nemzés fogalmát is emeljük ki: a [[K/Kozmogónia és kozmológia\|kozmogónia és kozmológia]] címnél taglalt ősnemzést itt átugorva kezdjük azzal, hogy Nimrud nemzi Szíriuszt (ez Nimrud nevének értelme is), kiknek fia a Nap. A Nap nemzi a Földet, melyből az élet, az anyagi élet fakad, mely anyag részint az, amely testként adja az ember egyik komponensét. A Nap [[N/Nép\|nép]]ét (N-P vázú mindkét szó, mutatva az összefüggésre) alkotja az ember.  

[[O/Orion#Orion mint Nyilas/Vadász – Orion/Aryan és Pabilsag problematika\|Orion mint Nyilas/Vadász – Orion/Aryan és Pabilsag problematika]] cím/alcímnél és [[O/Orion#Orion öreg vagy Nyilas öreg\|Orion öreg vagy Nyilas öreg]] cím/alcímnél Gyárfás Ágnes azon gondolatáról volt szó, hogy Orion a fiatal Nyilas/király és Nyilas (illetve a Nyilasban járó Nap) az öreg.  

<!--section: 29-->
### Nap az Orionban

<!--section: 29.1-->
Valójában az előző alcímnek is ezt a címet adhattuk volna, mert ott is az volt a lényeg, hogy Nap az éves útján hol tart.  

Itt még csak csak annyit, hogy a [[P/Pogány\|pogány]] értelme is megegyezni látszik a [[S/Szkíta\|szkíta]] = nyilazó értelmével, de nem a Sagittarius-Nyilasra vonatkozna, hanem a Nap Orionban lévő állására.  
[[M/Mithra\|Mithra]], [[O/Ozirisz\|Ozirisz]], [[N/Ninurta\|Ninurta]], [[B/Bál\|Bál]] illetve [[B/Balog\|Balog]], [[A/Andor\|Andor]][^16] és sok-sok más alakra mondtuk, hogy ők képviselik a "Nap Orionban" való állását. (Fentebb volt szó másokról is.)  

[[V/Vezér#Vezér mint Nap(isten) vagy Orion (Isten) – Ozirisz sem más mint Nap az Orionban\|Vezér mint Nap(isten) vagy Orion (Isten) – Ozirisz sem más mint Nap az Orionban]] cím/alcímnél is írtuk:  
...
Jankovics Marcell Ahol a madár se jár című könyvében talált passzusában írja még, hogy – az Orionnak megfelelő – villámot rázó esőistenek, amilyen [[M/Marduk\|Marduk]], [[T/Tesub\|Tesup]] és [[Z/Zeusz\|Zeusz]], ifjú korukban napistenek voltak.  

[[S/Samas\|Samas]] címnél is szóba került a téma akkád-asszír összefüggéssel:  

<div class="transclusion internal-embed is-loaded"><a class="markdown-embed-link" href="/S/Samas/#k96pz5" aria-label="Open link"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="svg-icon lucide-link"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></a><div class="markdown-embed">



A Martin Klingbeil Yahweh Fighting from Heaven című könyvében elemzett íjas Samash ábrázolások felvetik, hogy az Orionban járó Napot ábrázolják. A Kalbu Samas kifejezés is éppen jelentheti ezt: Nap kutyája.  
...
<!--section: 30.1-->
Másutt is szerepelt:  
A hivatalos tudomány is megerősítette, hogy a Naprendszerünk az Orion-köd mintegy 100 fényév-szélességű M67 nevű klaszterjából született.  
...
<!--section: 34-->
#### Pintye Mihály és Juhász Zsolt Magyar mitológia: Ki volt Emese?...

<!--section: 34.1-->
...című 2006/1. sz. megjelent cikkükben hasonlóképpen írják:  
> A Nap elküldte saját vándorlelkét fehér sólyom alakjában és megtermékenyítette Emesét a nőstény szarvasmarhát (szarvast). A Nap reinkarnálódott, újjászületett Emese közvetítésével. Az utód, esetünkben Álmos a Nap reinkarnációja. Korabeli címén a Nap fia. Az utód halála esetén a Nap vándorlelke rászáll madár képében a kiválasztott újabb utódra. A felfogás funkcionálisan nem tartja fontosnak az egymást követő reinkarnációk vérségi kapcsolatát. Rátermettség alapján választották ki az utódokat.  

Csihák György [[H/Hun\|hun]] címnél álló passzusában is elmondja, hogy amennyiben a Hun értelme Nap fia lenne, nem lenne egyedülálló.  

<!--section: 35-->
#### Huszárik László Zodiákus a kelták földjén...

<!--section: 35.1-->
...című a Zürichi Magyar Történelmi Egyesület Acta Historica Hungarica Turiciensia XXIX./1. sz. megjelent cikkében is írja:  
> [[S/Sumer\|Sumer]] és Somerset népe egyaránt a Nap gyermekei. Druida papjaik napjainkig ápolják a Naphoz kapcsolódó kultuszaikat.  

<!--section: 36-->
#### Jankovics Marcell...

<!--section: 36.1-->
...forrásaiból is tudjuk, hogy a [[S/Sámán\|sámán]] (mondhatjuk, ellentétben a táltossal) a Nap ember. A Nap könyvében is írja:  
> Az első ember, aki tehát az eredetmondákban mindig az ágyékából származó nép első fejedelme és főpapja (sámánja) is egy személyben, rendszerint a Nap fia vagy leszármazottja.  

<!--section: 37-->
#### Bakos Attila A Duna Evangéliuma...  

<!--section: 37.1-->
...című könyvének 168. oldalán több sárga színnel kapcsolatos adatot ad meg majd ezt írja:  
> Ázsia, Afrika és civilizált lakóinak szokásai és hagyományai vonatkozásában azért éppen a sárga lett a királyok, püspökök és a királyok temetésein celebráló papok megkülönböztető színe, mert a Nap gyermekeinek tekintették magukat. Mi sem természetesebb annál, mint hogy öltözékük színét apjuk, a Nap után választották meg, ezzel jelezve emelkedett rangjukat és családjuk kiváltságosságát. Mayapán királyai is a Nap gyermekeinek hívatták magukat.  

[[N/Nép\|Nép]] címnél és másutt is volt szó őseink leszármazási felfogásáról. Isten a teremtő a legelső ős. Csillagkép alakja Orion, az Égisten, kinek fia a Nap, kinek fia vagy mása a király: mindenképpen a feladatkörét látja el és a neve is megfelelő ([[K/Király\|király]] és [[T/Turul\|Turul]] is azonosnak vehetők). Régen, főképpen a tündérek korában és a mesékben mindenki király volt, és csillagnak, Napnak született. A Nap fia értelmezés csak egy változata ennek, mutatván, hogy egylényegűek, de valamiféle alárendelt viszont már kifejez.  
[[T/Taksony\|Taksony]] nevét értelmezve Péterfai János megállapítja, hogy Tak-Son tehát valódi uralkodói nevet viselt, aminek a jelentése a Nap-Fia.  
Lásd még Oláh Imre írását is [[K/Király#Napkirály, szakrális király\|Napkirály, szakrális király]] cím/alcímnél.  
...
<!--section: 39.1-->
...című cikkében írja:  
> A másik egyiptomi vallás a Napisten (UR, RA) tiszteletét követte, ezt az elvontabb filozófikus hajlamú vallást, ázsiai eredetű népág hozott Egyiptomba. A vallás követői magukat a Napisten fiainak, az ő vérségi leszármazóinak tartották. Eredetüknek megfelelően Ur-i (árja) néven szerepeltek a történetben. Arcuk világos színű volt és főleg földműveléssel foglalkoztak. A Napisten tisztelete a két Egyiptomban az V. dinasztia idejétől kezdve rohamosan terjedt. A király személye is szoros kapcsolatba került a napvallással, amit az is jelez, hogy ettől kezdve uralkodói címei közé a "Nap fia" jelzést felvették. Csak az az ember lehetett Egyiptom királya, akinek erejében az UR vére folyt. A vérségi kapcsolat annyira fontos volt, hogy annak nemlétében pótlásáról kellett gondoskodni. Egyház bölcsei kijelentették hogy azon a bizonyos éjszakán, amelyen a fogantatás történt, a Napisten személyesen lejött az égből és ő végezte a megtermékenyítés művét is. Eszerint a trón jelöltje az uralkodásra vérségi jogon is alkalmassá lett (Budge, The Gods of Egyptians I. 329).  

Arra is emlékezzünk, amit Várkonyi Nándor írt egyik könyvében:  
> Az egyiptomi teremtésmitológiában az emberek (remetj) Ré napisten [[K/Könny\|könny]]eiből (remit) keletkeztek. A két szó összehangzása az egyiptomiak számára biztos záloga volt az isteni könny és az ember genetikus kapcsolatának.  

<!--section: 40-->
## Napatya és Napfiú

<!--section: 40.1-->
Fentebb történt már utalás ide. Miről van itt szó? Arról, hogy elsőként Nap-Atya ugye lehet kétértelmű: Nap, aki atya és Nap-atyja. A második megoldással fentebb foglalkoztunk. Itt első esetről lesz szó. Ugyanis ismert a világon mindenütt az a képzet, hogy a Nap atyja az emberiségnek ([[N/Nép\|nép]]nek). Talán több helyen is volt szó erről, sőt, valahol le is vezettem, hogy Isten, aki az égen Orion lehet az egyik Atya (bolygóminőségében lehet [[J/Jupiter\|Jupiter]] is ilyen atya, akinek bátyja [[S/Szaturnusz\|Szaturnusz]], a Nap gonosz nagybácsikája), fia a Nap, annak fia az ember és az ember fiai a leszármazottai.  
A Napnak Napatyai ([[V/Világügyelő\|Világügyelő]]i) szerepköre az utóbbi évezredek Napvallásából kialakult nézet. Az ősibb nézet az, amely a Napot Napfiúnak tekinti/hívja. Mi a különbség a kettő kettő között? Hát az, hogy Napatyának nincs, vagy nem fontos az anyja, és ha van is számon tartva felmenője, az is Atya. Ellenben a Napfiú mindig a Szűzen Szülő Anya fia (ahol a Nap atyjának pontos személye ismeretlen vagy nincsen számon tartva). Utóbbi szinte követeli, hogy a Fiú Anyját tiszteletben tartsák (itt még lehetne arról beszélni, hogy a Napgyermek/gyermek két szülővel bír, de a szülés aktusát az anya végzi), sőt, mivel erőtlen gyenge fiúról van szó, elsődlegesen az Anya tiszteletét kell fenntartani. Mint a vallástörténelem bizonyítja, nem igazán sikerült. De a szkíta eredetű kereszténységben még 2000 évvel (ha valóban annyi) ezelőtt is sikerült olyan vallást létrehozni, mely az ősi anya-fiú relációra épült, majd a kereszténység judeo-krisztianizálásával (a patriarchális judaizmussal való keveredtetésével) sikerült majdnem teljesen kiiktatni, legalábbis egyházi szinten az judaizmusban nem tisztelt istennőt (a nép tisztelete az Istennő felé sokáig megmaradt nemcsak Magyarországon – máig is – hanem Írországban, továbbá egyes latin országokban vagy azok egyes részeiben [[M/Mária\|Máriá]]t máig nagyobb tisztelet övezi, mint a csodatévő [[J/Jézus\|Jézus]]t).  
A [[M/Magyar ősvallás\|magyar ősvallás]]hoz való ragaszkodás tehát a szkíta kereszténységben és a nép ajkán és szívében is kimutatható, melyből megint az derül ki, hogy a [[M/Magyar és hun utódnépek vallásszakadása\|magyar és hun utódnépek vallásszakadásá]]nak elsődleges oka a hun részről okolható meg (lásd még [[N/Napvallás\|Napvallás]] és [[S/Szemiták és árják\|szemiták és árják]] címnél írottakat is). Mindez átvezet még ahhoz is, hogy mely vallási oldalak hogyan állítják össze Szentháromságukat (a hivatalos nevetséges és petíciót kellene mindenkinek írnia a helyreállítás érdekében, ahogy a Quorán adott egyik válaszomban meg is fogalmaztam).  

<!--section: 41-->
## Nap – Ellen-Nap

<!--section: 41.1-->
[[E/Ellen\|Ellen]] címnél már volt róla szó, hiszen fontos lenne tudni talán azt is, mit jelent az ellen. [[F/FÉK\|Fék]] és [[K/Kantár\|kantár]] címnél azóta új írások is születtek (ellentartásról, negatív visszacsatolásról).  
...
- [[K/Kámán#^yr4g5w\|Kámán]] címhez betéve.

Viszont ha Péterfai János adata szerint `Us` = halál, akkor az első neve is ilyen jelentésű.  

Ellen-Nap vagy másik Nap a [[S/Szíriusz\|Szíriusz]] is. Erről legutóbb [[G/Győz és gyász\|győz és gyász]] címnél is volt szó.  
...
Szíriusz és Szaturnusz égitestekben az a közös, hogy mindkettő kapcsolódik [[S/Széth\|Széth]]hez.  
Ezek alapján a [[F/FÉK\|fék]] és [[K/Kantár\|kantár]] címnél is taglalt latin [[C/Contra-\|contra-]] is lehet HunTár = Hun Nap, vagy [[H/Hunter\|hunter]] = [[V/Vadász\|vadász]], aki a Csudaszarvasünőt űzi, s hajtja a csillagképeket. Sőt, a `Hunter` Vadász lehet maga az [[I/Íj csillagkép\|Íj csillagkép]] is, mely valóban ellene = szemben van a másik Nyilazó/Nyilassal és a Tejútközponttal.  

Ellen-Napról meglepetésemre Kubínyi Tamás is szól [alábbi]([https://youtu.be/aeRDLskUSZM](https://youtu.be/aeRDLskUSZM&t=2375s)) Turul és Szarvas II. rész című ÁKA előadásban 39:35-nél, úgy mint az ellipszis alakú földpálya másik fókuszpontjáról.  

Sajnos az egyéb csillagászati információi azért használhatatlanok, mert például 37:26-nál és előtte rosszul magyarázza, hogy a téli napfordulón lennénk a legtávolabb a Naptól, holott január 2-án éppen a legközelebb vagyunk hozzá (lásd [[U/Újév\|újév]]). Valójában a Föld tengelye télen elfelé áll a Naptól.  
Kár, hogy a téli napfordulót nem jól mondta és hogy a precessziós időkörről átváltott a kis éves körre, magyarázat nélkül. (49:45-nél tér vissza rá, de csillagászatilag nem, csak a 9-es számrendszerbeli számokkal babrál.)  
Ide köti 40:29-nél a [[S/Sphinx\|Sphinx]]-et is, de sajnos nem beszél róla olyan csillagászati összefüggésben, mint vártam vagy ahogy én írtam (ugyanis ott is a Nap-ellen-Nap téma jön elő; nem lehet véletlen Hun Apu neve). (Mindenesetre az, hogy az előadásba valamilyen oknál fogva bevette, azt mutatja, hogy tudat alatt tudta, ide kapcsolódik. Csak éppen nem dolgozta ki. Helyette azzal folytatta, hogy a szabírjaink elzarándokoltak hozzá.)  

Valójában a Nap – Ellen-Nap reláció a Fiatal Nap ([[M/Magor\|Magor]]) és Öreg Nap ([[H/Hunor\|Hunor]]) ellentétpárra épül.  
A (Kronosszal elkezdett) fentiek szerint [[P/Pán\|Pán]] is azért hozatott kapcsolatba a Bakkal, mert Szaturnusz ott van erőben (de Vízöntőben is) és Szaturnusz a Nap opponálója, ahogy a Pánnal szintén kapcsolatba hozott Szíriusz is (de a [[S/Sarkcsillag\|Sarkcsillag]] is a [[N/Nap – halott Nap\|Nap – halott Nap]] helye).  
Viszont Hunorhoz és a fentebb is említett [[S/Széth\|Széth]]-hez kapcsolódik a fentebb írottak alapján is Orion, kinek viszont [[S/Szaturnusz#Szaturnusz és Orion\|Szaturnusz és Orion]] cím/alcímnél írottak alapján bolygópárjaként megfelel Szaturnusz. Mondhatnánk úgy is, hogy az [[O/Öregisten\|Öregisten]] fogalma alatt Orion és Szaturnusz egyaránt érhető. Öreg áll szemben a fiatallal és a hatalomátvétel [[F/Félév\|félév]]ente történik. Az Öreg Orion lehet [[S/Szamár\|szamár]] és ördög/[[K/Kontár\|kontár]] is, mely kontár és [[K/Kantár\|kantár]] = [[H/Hunter\|hunter]] = Orion és a [[C/Contra-\|contra-]] = ellen fogalmát is hordozza. Kontra fogalmáról [[F/FÉK\|fék]] címnél is volt szó, negatív visszacsatolás kapcsán.  
Az [[A/Anti-\|anti-]] ellen értelmét is az [[A/Anta\|anta]]/An-Dar/Hun-Tar fogalmak alapján kell értelmezni.  
A [[N/Nap – fekete Nap\|Nap – fekete Nap]] alatt sem kell mást látni, mint az ellen-Napot. A [[H/Hunor és Magor\|Hunor és Magor]] rendszerben [[H/Hunor\|Hunor]] a fekete Nap.  

Ide, ehhez az alcímhez is betehetném, de legyen inkább külön, [[M/Magyar mint Szíriusz\|Magyar mint Szíriusz]] címhez téve az a téma, hogy az ellenoldal miképp lett úgy számításba véve, hogy félreértésből Magor és hasonló nevek megjelenhettek (volna) Szíriuszra utalva.  

<!--section: 44-->
## Nap – vörös Nap

<!--section: 44.1-->
[[H/Három nap\|Három nap]] és [[M/Makara\|Makara]] címnél is szerepelt Jankovics Marcell ezen sora, melyből kiderül, hogy **a vörös Nap az újszülött Nap**:  
> Héraklész, amikor három nap után kivágja magát a tengeri szörny gyomrából, kopasz és vörös, mint egy újszülött.  
- Itt viszont kis éves időkörről van szó; a napi időkörben is lehet vörös a Nap: felkeltekor (születés), és lementekor.  
Lásd még továbbá [[M/Mikulás\|Mikulás]].

<!--section: 45-->
## Nap – pusztító Nap

<!--section: 45.1-->
Jankovics Marcell A Nap könyve című könyvének 188. oldalán szereplő anyaga nem tehető ide; [[F/Finnugor rokonság\|finnugor rokonság]], [[K/KUN\|KUN]] és [[S/Suomi\|Suomi]] címnél volt már róla szó érintőlegesen.  

Pap Gábor tett arról említést, hogy egyes, a Föld egyenlítőjéhez közeli helyeken [[H/Holdtisztelet\|Hold-kultusz]] alakult ki, egyszerűen azért, mert a Nap nem adományozónak, hanem pusztítónak fogatott fel.  

<!--section: 46-->
## Nap a Tejúton

<!--section: 46.1-->
A [[N/Nap háza\|Nap háza]] a Tejút, mondhatnánk röviden.  

<!--section: 47-->
#### Jankovics Marcell írja:

<!--section: 47.1-->
> A szellemeknek a karácsony esti harangszó csinál utat; a zengés-bongás – hitte egykor a székesfehérvári paraszt-polgár – nyitja meg az eget, s létrejöhet az "élők és a holtak karácsonyi symposionja". Ez a képzet közvetlenül az ókori csillaghitben gyökeredzik, mely szerint az istenek, a (gonosz) szellemek és az eltávozott valamint a megszületni vágyó lelkek a Tejúton közlekednek evilág és túlvilág között, de az átjárás csak akkor szabad, amikor a Tejúton, a patakvízből kiemelkedő kövekhez hasonlóan, planéták is tartózkodnak, és a lelkek egyikről a másikra szökellve az égből a földre, a földből az égbe szállhatnak. Elterjedt hiedelem szerint az is elegendő, ha csak a Nap tartózkodik a Tejúton, a világok közt járók rajta keresztül is átjutnak. Másképpen szólva, a régiek a Napot a "túlnanra" nyíló kapunak tekintették. A "megnyílnak az egek" metafora tehát arra az időszakra utal, **amikor a Tejúton jár a Nap**. Ez jó ideje már a karácsony illetve a Szent Iván-nap körüli időbe esik.  

A témáról lásd még [[G/Galactic centre\|Galactic centre]] és [[T/Tejút\|Tejút]].  

<!--section: 48-->
#### Jankovics Marcell írja:

<!--section: 48.1-->
> Tisztán a középkori szellemben fogant Jézus jászol-szalmaágyának sugaras mandorlaként való értelmezése. A kép a napistenhit hatásának következménye: a téli napfordulatkor a tejúthasadék, az anyai [[O/Öl\|öl]] – erre utal a fénykoszorú mandula formája – a születő napgyermek fényébe öltözik.  

Fényébe öltözik, azaz a Nap ott tartózkodik, mint a fentebbi példában a nyári napfordulókor Orion.  

<!--section: 49-->
## Nap és Föld

<!--section: 49.1-->
Berényi László Géza Holisztikus szemlélet a Kárpát-medencében című az Ősi Gyökér 2014/3. sz. megjelent cikkéből való a mellékelt kép és a hozzávaló szöveg.  
![assets/NapMAIN_image26.jpeg|fix_dark fix_light](/img/user/N/assets/NapMAIN_image26.jpeg)  

<!--section: 50-->
### A Nap – Föld rendszer jellemzői

<!--section: 50.1-->
A Föld bolygó Nap körüli ellipszis pálya második gyújtópontjának távolsága az elsőtől (a Nap középpontjától) 3,6 D (D = Diameter) azaz a Nap átmérőjének 3,6-szorosa.  
Itt két távolság (két méret) közötti arányról van szó, amely a bolygó keringésével kapcsolatos információ.  
Mindkettő "skálainvariáns", azaz léptéktől függetlenül érvényesül.  

Arról sok helyen volt szó ([[B/Barát#^1f1clu\|barát]], [[M/Magor\|Magor]], [[H/Hímség és nőiség\|hímség és nőiség]], stb.), hogy minden a Nap és Föld kapcsolatáról szól: a nőnemű Föld kering a hímnemű Nap körül.  
Ennek a nyelvben, a szavak létrehozásának szintjén is meg kellett mutatkoznia. Nap-Föld etimon-szintű összeállásáról több helyen volt szó; lásd pl. [[M/Magyar ősnyelv szótagnyelv#Kétszótagú szavak összeállása\|kétszótagú szavak összeállása]].  
...
<!--section: 52.1-->
...című könyvében igen érdekes dolgokat oszt meg (több helyen szerepelt):  
...
[[B/Bal és jobb\|Bal és jobb]] címnél Molnár V. József több adata mutatott oda, hogy a Nap oldala a bal és a Holdé a jobb. Két ide is rakható kép is szerepelt ott könyvéből.  

Falvay Károly Nagyboldogasszony c. könyvének 135. oldalán írja ([[S/Szentháromság\|Szentháromság]] címnél másképp szerepelt):  
> Az időváltozást előjelző Hold 12-es és 7-es ritmusa tette lehetővé a természetben a napfelkelték követését. A 12-es rendszer kialakulása után következhetett a holdváltozások közben megismert harmadik rendszer a napfordulók és napéjegyenlőségek fontosságának négyes felismerése,...  
> A legrégibb szentháromság-rendszer az anya-leánya-fiúgyermek hármasság. A mi számunkra feltűnő és figyelemre méltó: ebben a hármasságban a magyar istenanya képzetek a legősibb anya-leánya-fiúgyermek mitológiai emlékeket őrzik. Ezekről beszélnek archaikus gyermekjáték-, és az apokrif imákat tartalmazó szövegeink. Ezért kezdjük az évet a Boldogasszony-hava elnevezésű holdhónapunkkal, s ezért általános az európai gyakorlatban a "hétnapos" hét és a 12 "holdnapos" hónapelnevezés.  
> ![assets/NapMAIN_image27.png|fix_dark fix_light](/img/user/N/assets/NapMAIN_image27.png)  
> A Nap és Hold együttes szerepe, Szűz Mária kultusza nélkül, de természeti képzetként és \[nem oly\] meglepő módon \[a kereszténység magyar eredetű!\] éppen a magyar református templomokban ismét hangsúlyt kapott. Feltehetően viszszatértek korábbi, még hagyományosan élő régi magyar természeti képzetekhez, melyek főleg az 1600-as évek végétől a templomok kazettás menynyezetein tűnnek föl. Szép példája a kalotaszegi magyarbikali templom kazettás mennyezete, ami 7x12 sor kazettájával e természeti Hold-Nap kettős rendszer egységének nagy fontosságát hangsúlyozza. Olyan példákat is idézhetünk, ahol a férfiak fölött a kazetták közepén a Nap, a női kazettás oldal fölött a Hold alakját formázták meg (például Felsődoboly, Háromszék v. m.), alattuk a megfelelő szerepkört megfogalmazó férfi és női közösséggel. E téma párhuzamának akár vallástörténeti, akár néprajzi kutatása eddig föl sem merült \[majd Pap Gábor elővette gondolom\].  

Nap és Hold bal- és jobb oldalon létéről (és ezen oldalakon való ábrázolásáról) lásd [[B/Bal és jobb\|bal és jobb]].  

<!--section: 53-->
### Égitestek népek és hazájuk nevezeteként
...
<!--section: 54.1-->
...című könyvében írja:
> Hogy a turániak előázsiai hazájukat két égi testről nevezték el, az abban a korban természetes és szokott eljárás volt.  
> Hiszen tudjuk, hogy a kínaiak is a menny birodalmának, a japánok pedig a fölkelő nap országának nevezték hazájukat. Ezenkívül a továbbiak folyamán több néppel fogunk találkozni, amelyek szintén egy-egy égi vándorral hozták magukat és országukat ilyen összeköttetésbe. ([Lásd 10. old.](zotero://open-pdf/library/items/VZZUZWZ2?page=10&annotation=RLZYRLNP))  

<!--section: 55-->
### Nap és Hold égitestek a nép ajkáról és a népi hagyományban
...
<!--section: 56.1-->
...című könyvében írja:
> A közmonda "[[N/Napa#Napa 1)\|napa]]d nem gondolja, hogy ő is csak [[M/Men\|meny]] volt", magában mutatja a nap és men szók egykori szoros összefüggését vallásos körben, melyből azok a közéletre átvitettek, miként a hold és nap szók alatt eléggé kifejtve van, s jelenben is a meny szónál a női különbség a két nem összeházasítása, a mythologiákból felmutatható, hol a `men` törzsszó, napot, holdat, eget, teremtő szellemei stb. jelentett. ([Lásd 280. old.](zotero://open-pdf/library/items/DFI47XPY?page=280&annotation=P697K7X3)) ^DFI47XPY-P697K7X3
- Más hasonló közmondások:  "Menyecskének, ha mézből volna is a napája, nem kedves." – "Napa ritkán alkuszik meg menyével."

Kállay könyvének a magyar Nap és Hold nevekhez rendelt prófétákra neveire vonatkozó adatát is tegyük ide, mert ezek is a magyar nép ajkáról őrződtek meg utódnépeinknél:  
> A schémi nyelvágazatokban `nub` pullulare, progerminare, `nib`, `nob`, fructus, `Nob` urbs sacerdotalis, `nabia` = vates, `nebia` profetissa (Wiener p. 591. 592. 606.), mint a holdnak volt `hulda`, vagy `khulda` = próféta asszonya (l. hold), ugy a napnak is ily nap profétája, és jóslónéja. ([Lásd 296. old.](zotero://open-pdf/library/items/DFI47XPY?page=296&annotation=82LTQB38))

Nap és Hold vallásos összeházasítása kapcsán pedig:  
> Igy van a dolog a szláv `nebi` ( = ég) szóval is, mely a görög `nephos`, Zend `nev`, latin `nubes`, `nebulu`, német `Nēbes`, `Nēbal`, `Nabel` szókkal gyakran összehasonlittatott már, homály, köd, sötétség értelemben, tehát a világító fénynyel ellentétben. Az ily átmenetek jóból rosz értelemre vallásos szóknál gyakoriak (l. ármány, s öröm, rosz, stb.), a latin `nubo` ige pedig, honnan `innubus`, `pronubus`, `subnubus`, `enubo` kezdetben a nap és hold össze házasitását tárgyazta (l. hold), a termékenyítő erőt jellemzé, a magyar `napa`, syrus `nabato`, zsidó-arab `nib`, `nub`, az ó persa `napja`, samojed `nebe` szókból is kivehető, melyek részszerint az összeházasodási viszonyok, részszerint az azokból lett eredmények, tehát productumok fogalmait fejezik ki. Vagy történetes összehangzás-e a `nap` és `napa` (socrus) a `meny` (coelum) és `meny` (nurus) menyasszony? (sponsa, bizonyára nem, a ki azt hinné, keveset forgolódott még az ősvilági nyelvek körül, még kevésbbé hatott be a keleti vallások bölcseleteibe, melyeknek az élet nyelvére kihatása tagadhatatlan (l. meny szót), melyek épen a nap, hold, meny, ég, közös törzsszókban, legszebb irányait mutatják fel az összehasonlitási működésnek, mely most a tárgyakat szellemesiti, majd ismét az eszmeiséget tapasztaltatja. ([Lásd 304. old.](zotero://open-pdf/library/items/DFI47XPY?page=304&annotation=3DSD6QAS))
- Viszont a két ellentétes elem/elv háziasítása ad okot a vallási alapú szembehelyezkedésre és egyúttal azonos alakú nevek jó és rossz értelmére, mely ismét csak a körelmélet/életkör-felfogás eredménye.

Lásd még Péterfai János: 
> A Hold másik nagy eszmerendszere a Nap-Hold-Csillag fogalomból ered.
- A holdnak és a csillagnak is van(nak) M-N vázú neve(i): meny nőiségként, mén hímségként és mennyei gyerekként [[M/MIN\|MIN]].

Lásd még [[M/Minerva#^DFI47XPY-UX95W7N7\|Minerva]] címnél álló Kállay passzust is.  

<!--section: 57-->
#### Wohlfart Zoltán A Maros (Nap) és az Olt (Hold)...

<!--section: 57.1-->
...című az Ősi Gyökér 2018/1-2. sz. megjelent cikkének alábbi adatsora [[M/Maros\|Maros]] címnél (ott bővebben) is szerepelt:  
> A Hold gyorsabban halad az égbolton, mint a Nap;  
> Az újhold születésekor eltávolodik égi társától, majd fogytában közelít hozzá;  
> A fogyó Hold elvékonyodott sarlóját végül befogadja a Nap;  
> A Nap látszólagosan marja a fogyó Hold testét, míg a maradék égi vándor magjával beoltja a tüzelő társát.  
>
...
> A fogyó Hold (h)-olvad az "ég vizében"; - Napfelkeltekor a fogyó Hold feloldja alsóvilági fogságából a fény hordozóját, miközben feláldozza magát a Nap tüzében;  
> A hal formájú égitest halálakor elődeink feltehetőleg hálából (h)-áldozatot mutattak be;  
> Naplementekor a fogyó Hold kioltja társa tüzét.  

<!--section: 58-->
### Nap és Hold a mesékben

<!--section: 59-->
#### Jankovics Marcell írja:

<!--section: 59.1-->
> A segítő csak egyik alakjában és szerepkörében hátasállat, s mint a [[T/Táltos\|táltos]] jelző és csodálatos képességei mutatják, felsőbbrendű, csak gazdájánál alábbvaló lény. A hős esetében láttuk, hogy az állattá (még inkább növénnyé vagy élettelen tárggyá) változás, az "állatrészek az emberben" – van ilyen című mesetípus is –, "rangvesztés"-t, alacsonyabbrendűséget fejez ki. Ezt jelzi többek közt a hátaslószerep a segítőnél. Felsőbbrendűségére utal viszont az ábrázolások tanúsága szerint, hogy emberi arca van és beszél. Ha ember képében jelenik meg, a hőssel közel egyívású alakként, akkor is csak másodhegedűs mellette. Mindazonáltal a Holdat testesíti meg, aki nélkül a naphős a sötétség erőivel szemben semmire sem menne. Ezt fejezi ki az asztrológia azzal, hogy a Szaturnusz "karriervonalát" a Nap és a Hold együttes pályafutása egyensúlyozza ki a méltóságok és gyengeségek jegyek közti elosztása szerint. Magyarán szólva, a győzelemhez mind a hősnek, mind a segítőnek jó erőben kell lennie, s hogy ezalatt mit kell értenünk, arra nézve is ad támpontot a mese: amikor Mezőszárnyasi táltosa hátán a megszabadított leánnyal hazatér, a Nap nyugszik éppen és holdtölte van. Teliholdkor a fény uralma folyamatos: napkeltétől napnyugtáig a Nap, napnyugtától napkeltéig a kitelt Hold világít (a hazatérés és a napnyugta is egymásnak megfelelő történések. Mesë a sëteet ország királyáraó). Amikor Kiss Miklós a zöld király zöld leányával – zöldek, mert itt a tavasz! – lova hátán hazakocog, a Nap és a Hold vígan kezdenek fényleni (Az ólom-barát).  
- Ezen passzus [[L/Ló\|ló]] címnél is szerepelt.

> Amennyivel ügyetlenebb többnyire – a bal kéz a jobbnál, sápatagabb és könnyebben szennyeződő fém az ezüst az aranynál, tisztátalanabb és puhább kő a kristály és a gyöngy a gyémántnál, fakóbb és változékonyabb a Hold a Napnál, annyival marad el a segítő a hős mögött. Ugyanakkor a Nap és a kitelt Hold látszólagos méretazonossága ikerségükhöz szolgált alapul a mesékben is:  
> A két egyforma testvér, Az aranyhajú ikrek fiúhősei a Napot és a Holdat viselik testükön. Világbíró Nagy Mátyás társa, Szigeti, színre, szemre Mátyás kiköpött mása, csak éppen jóval gyengébb. Nap királyfi oldalán testvéröccse, Hold harcol az előbbi számára Tündérszép Majlona kegyeiért. Hold vitézre hárul a feladat, hogy Majlonát a Nap számára megtisztítsa a "rossz vértől": a "marsi hatásoktól", a Szaturnusz-sárkánnyal való közösködés nyomaitól, és szépségét, szűzi tisztaságát visszaadja. Ez a hős hordozása mellett a segítő másik fontos tennivalója, s ez is a Hold mitológiai szerepkörének része volt korábban. (L. a Két egyforma testvér, Két hű barát, Csonka és sánta pajtás, Amicus és Amelius, Jótéteményt megháláló halott típusú mesékben.)  
> A Hold eme funkciójának hiedelmi alapja lélektani eredetű, amit a pszichoanalitikusok "kasztrációs komplexus"-nak neveznek. Elterjedt hiedelem szerint régente a férfiaknak bizonyos esetekben óvakodniuk kellett a nőktől (például, ha szüzek, a szűzhártya "élétől"; ha terhesek, a magzat "fogától"; ha rajtuk van a havi tisztulás sora, tisztátalan vérüktől), mert könnyelműségük következményeként férfiasságuk elvesztésével fizethetnek (ez fenyegeti a hőst a felsorolt mesékben). A bajt elhárítandó időszakos közösülési tilalommal éltek, valamint különféle babonás praktikákkal. (Ilyen volt az excisio, a csikló kimetszése, mely a férfiak [[K/Körülmetélés\|körülmetélés]]ének felelt meg, vagy a szűzhártya "műtéti" eltávolítása. A ius primae noctis szokásának is ez volt az eredeti értelme: a szüzek defloreálását a különleges képességekkel megáldott férfiakra bízták, vagy olyanokra, akikért nem kár.) A mesehősök e szokásokat is gyakorolják. A kép teljességéhez tartozik, hogy nemcsak a nőkbe hatoló férfiút féltették, hanem, ha a nő anyai örömöknek nézett elébe, a magzatot is a férfitől. A mesék mindig arra a veszélyre hívják föl a figyelmet, ami a hőst fenyegeti. Ha közösül a sárkányfattyúval terhes nőszeméllyel, őt féltjük, mert "varázseszközét" elveszítheti; s őt féltjük akkor is, ha ő a magzat, hisz most őt fenyegeti abortusz a behatoló "ellenséges" fallosztól.  
> A holdsegítő e veszélyeket elhárítandó helyettesíti a naphőst a nászágyban. De miért éppen ő?  
> Többé-kevésbé elfogadott nézet szerint a Holdat azért tették meg a termékenység: a [[H/Hymen\|hymen]], az anyaméh és a [[M/Menses\|menses]], valamint a szülés dajkaistennőjének, mert növesztő – apasztó képességet tulajdonítottak neki (l. árapályjelenség), és mert a holdváltozások és nők havi ciklusa, illetőleg a terhesség, állatoknál a vemhesség időtartama között az ember kapcsolatot vélt fölfedezni. Alighanem joggal, bár e kapcsolat ok-okozati összefüggései tisztázatlanok. Az a kép, hogy a Hold szűz, illetőleg meddő istennő, ebből származhat, hiszen sohasem marad ki egy havi ciklusa sem. (Figyelemre méltó, hogy a Hold jele akár a szüzesség, a szűzhártyával részben takart hüvelybemenet jele is lehetne.) Hasonlóképpen, mint férfisegítő nyugodtan föláldozhatja "varázseszközét", hisz nemzésképtelen (a holdparipa = herélt csődör); Nap fivérének a feladata, nem az övé, hogy a földanyával egyesülve a természetet megújítsa.  
> Egy utalás erre nézve az antik mitológiából: Szelené holdistennő hátasát öszvérnek képzelték. Mint ismeretes, az öszvérnek nem lehetnek utódai. A holdfogyta a férfiatlanítás vagy az (időleges) impotencia jelképe is lehet, a havonkénti holdtölte ez esetben viszont férfiasságának kiszámítható "föltámadását" szombolizálja. (Vö. az egyiptomi képzettel, mely a ciklikus holdváltozást Hórusz égisten szemének sérüléseként és meggyógyulásaként írja le. A szem ~ here analógiáról már esett szó.)  
> A Nap-Hold fivérek "munkamegosztása" tükröződhet csillagképük, az Ikrek mitológiai neveiben. Az ikerpárok halandó tagját Kasztórnak (lat. Castor), halhatatlan tagját Polüdeukésznak (lat. Pollux) hívták. Kasztórt "hasba" szúrták, úgy ölték meg, s latin neve népi etimológiás alapon a kasztrációt idézi fel (lat. `castro`, "kiherél", "gyengít"), míg Polluxé ellenkező jelentésű igéket (`polleo`, "sokra képes", "ereje teljében van"; `polliceor`, "nyújt", "sokat ígér"; `polluceo`, "áldozatul hoz", "szolgál bőséggel"; `polluo`, "beszennyez", "szexuális értelemben meggyaláz", ebből orv. lat. `pollutio`, "magömlés").  
> A mesékben a segítő vagy mint "angyal-", helyesebben szólva "ördögcsináló" avatkozik be (ördögfattyak az abortusz végtermékei), vagy együtt is hál a veszélyes nővel, aminek szintén magzatelhajtás, a "rossz vértől" való megtisztítás vagy excisio a célja. A segítő olykor belerokkan a műveletbe, például közösülés közben elveszti a "lábát", de a nőt így is ártalmatlanná teszi vele. A hős persze hálából helyreállítja testi épségét.  
> Egy szolga gazdája frissen szerzett menyasszonyát kettétépi, a leányból kígyó, béka esik ki. Ezután összeragasztja, s a leány szebb lesz, mint volt (A színeváltozó királyné. A kettészakítás születés értelmű a kozmogón mítoszokban is). Legényt kísérőtársa felvilágosítja, hogy szerelme a denevérkirálytól teherben van; nem veheti el, mert rontás érné. Előbb forró édes tejbe kell a leányt aprítania, utána jeget vetni a tejbe, akkor a leány hétszer szebben (tisztán, szűzen) támad fel (Szegény János). Vízi Pál együtt hál bátyja feleségével, kettejük közé azonban meztelen "pallost" tesz, mondván, ha az asszony "valamijét" áttenné rajta, azt a kard azonnal elmetszi. A asszony a "kendőjével" próbát tesz, a kard széthasítja. (Vízi Péter és Vízi Pál. A kendő a hymen szimbóluma. Ugyane mese változataiban metszi le a hős pallosa a banya orrát. A pallos a fallosz helyett áll, az orr a csikló euphémiája, a vén banya pedig a vulva megszemélyesítője ebben az összefüggésben). Vándor herceghez útjában társul szegődik Csóré (azaz "Meztelen") királyfi. A herceg Csóré segítségével elnyeri az emberfeletti erejű királylány kezét. A nászéjszakán, a sötétben Csóré fekszik az újdonsült férj helyére, mert tudja, hogy ha a királylány valakin "által tette a lábát, az abba a helybe meghótt". Csórét ez a veszély nem fenyegeti, de a "lábát" elveszíti a szerelmi csatározásban (a "láb", akárcsak Oidipúsz esetében, akinek a neve azt jelenti: "Dagadt láb", a pénisz euphémiája). Később persze egy varázsszernek köszönhetően visszakapja (A világlátott királyi vitézről). A segítő akkor is elvégzi a "tiltott műtétet" és akkor is besegít a nászéjszakán, ha állat: például róka vagy táltos paripa (A próbára tett királyi, Zirínyi Miklós). Mindkettőről tudjuk, hogy a naphős elkötelezett híve, nap-, illetve ebbi minőségében inkább holdállat. A próbára tett királyfi rókája azért mond le könnyű szívvel a tündér őt megillető feléről, mert, mint az eunuchok, közömbös a női bájak iránt.  
...
<!--section: 61.1-->
Bakos Attila A Duna Evangéliuma című könyvének 468. oldalán írja, hogy a naplemente és napfelkelte előtti időszakban a legerősebb a kozmikus kisugárzás. Nem véletlen tehát, hogy az ima ideje ilyenkorra esik.  
Ehhez kapcsolódó adat Bars Máriától, aki elmondja, hogy kora reggel még a napsugarak az összes színeiket tartalmazzák, különösen az ibolya-sugarakat (déltájban a sárga, estefelé a vörös sugarak uralkodnak). Reggel az atmoszféra még meglehetősen tiszta és békés, úgyhogy az ibolya-sugarak könnyen áthatolhatnak. Éppen ezek a legfontosabbak számunkra, mivel ezek az iker-erőket, a magnetizmust, az elektrizmust, és ezzel az egész testünket polarizálják.  
Kora tavasszal a napfürdők hatékonyabbak, mint bármely más évszakban. (Másutt még kimondja, hogy a napfürdőzés és a napozás között különbséget kell tenni. A [[S/Szág\|Szág]], [[Z/ZAG\|ZAG]] és [[S/Sacchar-\|sacchar-]] címnél is említett orosz `zagoraty` is szakrális tevékenység kellett legyen.)  
Ami az ibolya-sugarak feltöltő hatását illeti, ez nagyon érdekes, és az ultra-ibolya tartományok is.  

<!--section: 62-->
## Nap nevünk idegen nyelvekben, kultúrákban
...
<!--section: 64-->
### Nap teremtő minősége

<!--section: 64.1-->
A leglényegesebb adatai közül:  
> Siciliai Diodor irja már Reland idézete szerint: "ad ortum solis qui Nabati vocantur, Syrus nyelvben `nabata` = crevit, germinavit, `nabato` = herbae plantae, fructus, tehát a zsidó arab `nub`, `nib`, `nob`, `naboth`, ismét syrül `naba` = fons, Masius szerint `nebha` igétől = effundere eractaere, ez ismét a zsidó arab hason jelentésű `naba` ige szó, hogy mindezek **a napisten munkálatai**ra visszavitethető szók, magától értetik, és Troger az indus Parvatira készült hymnus szövegek magyarázatjában, az ott szinte előforduló `nâbbi` szót tüzelemnek, vagyis inkább tűzforrásnak magyarázván (a syrus `naba`), helyesen jegyzi meg, hogy **keleten mint nyugoton a sok istennév, s isteni munkálatok a napban mint egy központositva vannak** (Journ. as. 1841. Sept. Octob. p. 273). ([Lásd 297. old.](zotero://open-pdf/library/items/DFI47XPY?page=297&annotation=9GP2EZ8V)) ^DFI47XPY-9GP2EZ8V
- [[M/Mén#^DFI47XPY-GIL9G7RE\|Mén]] címnél is szerepelt egy hasonló, "világalkotó" kifejezés. (A passzus [[N/Napvallás\|Napvallás]] címhez is linkelve lett.)

> Samojed földön `num`, `nub`, `nom`, `neb`, `nob` az ég neve Arndt szerint (p. 313.), mely az európai s ázsiai jeges-tenger vidékein szélesen elterjedve van. Klaproth szerint a samojedok istenneve `nob`, `nub`. ([Lásd 294. old.](zotero://open-pdf/library/items/DFI47XPY?page=294&annotation=MQABGCZL))  
> 
...
> 
> Grimmben `nap` skótul = patina (tehát nap tányérja), `neb` a.s. = arczkép (tehát a cserkész `nap`), Schmid sváb szótárában `Nap` (bernai Cantonban egy magos hegy, **Napp** más hegyfok, Nipf vogesi, egykor vulkán hegy, melyek egyszerű formái az alább megemlitendő szinte germán **Abnoba**[^18] hegyek. Ihre glossariumában `naf` cavitas, `nafe`, `nabe`, `nave` = concavum cambrice `nef` coelum, `nafle` umbilicus, `nafel`, `naul`, `nabalo`, `napalo`, `nabela` formákkal: ismét `Napp` = crater, poculum, `naph`, `nap`, `nappo`, `hanap`, `napf` stb. formákkal, Wachter glossariuma a cseh `nebe`, lengyel `niebo`, sorab `nebio` (= coelum) szókat is méltán ide fűzi; Bullet kelta szótárában pedig `naf` = seigneur creatour, tehát a teremtő nap. Hogy mindezek a sanskrit `nâbli` ( = umbilicus és focus ignis l. Troyert journ. asiat. 1841. octob.) a zend `nafedhrô`, uj persa `naf` szókkal egyek, magától értetik. ([Lásd 302. old.](zotero://open-pdf/library/items/DFI47XPY?page=302&annotation=3Y55KQ7M))  
> 
> Boppban (Vergleich Gramm. 1. Abth. Berlin p. 219-351. 355.) lithvánul `nabat` = coelum nebes. ([Lásd 302. old.](zotero://open-pdf/library/items/DFI47XPY?page=302&annotation=H8NM3EMC))  
> Ugyanaz a sanskrit `nabŭs`, `nebese` = coeli; a sanskrit `nab-as-as`, s ne feledjük, hogy az egyiptomi és indus nagyobb és kisebbszerü emlékeken a discus hold sarló rendes jelképei a napnak és holdnak. ([Lásd 303. old.](zotero://open-pdf/library/items/DFI47XPY?page=303&annotation=QVYSR3FL))
- Az ég sok nyelvben N-P, N-F vázú, ahogy erről [[N/Nebula\|nebula]] címnél volt szó.
- Akkor a latin Danubius is afféle konfláció lenne, melyben a Nap is belekeveredett?
- A skót szavak mellé:  
> Koreában `nap`-nak nevezik a fényes czint, a cserkész földön pedig `nap`, `napa` = arczkép. ([Lásd 294. old.](zotero://open-pdf/library/items/DFI47XPY?page=294&annotation=MQABGCZL))  
- A Nap arcképét az ember tenyerével is megjeleníthetjük: a dakota-lakota [[N/Nape\|nape]] = kéz.

> Wilkilson szerint is `hnub` = `kneph`, `khnuphis`, Plutarchban Thebais lakosai fő istene, kinek kezdete s vége nincs, a Mindenható világ lelke, azért az emlékeken kigyói alakban ábrázoltatott ki. (Gelehrte Anz. München 1838. X-ben Nro 249.) Ez a kigyó alak Othmár Frank szerint a denderai Zodiacus körében épen napkölte és dél közt van helyezve. A hieroglyphi feliratokban Noubmai Champillion magyarázata szerint a naptól szeretett, Neb-tho = világ ura. ([Lásd 301. old.](zotero://open-pdf/library/items/DFI47XPY?page=301&annotation=LZ4HWTHK))  
- [[K/Khnum#^DFI47XPY-LZ4HWTHK\|Khnum]] címhez is bekerült.

> Mind ezt összevéve s tekintve a föllebb elősorolt Napf, Nipf, Nap, ugyancsak germán földi hegy nevekre, mint azon történeti tényre, hogy a germánok is tisztelték a napot, ámbár nyelvekből a név ez értelme kiveszett is, és csak mellék jelentésekben fordul elő biztosan következtethetni, hogy valamint a kelták, ugy germánok is használták egykor a nap szót, a teremtő nap értelmében. ([Lásd 303. old.](zotero://open-pdf/library/items/DFI47XPY?page=303&annotation=Z9PTS65V))
- Ahogy fentebb is szerepelt, Bullet kelta szótárában `naf` = seigneur creatour, tehát a teremtő nap.

<!--section: 65-->
### Nap alapjelentés utáni szekunder jelentések

<!--section: 65.1-->
Több helyen szóltunk arról, hogy a Napot jelentő szavak mellékjelentései között mindig feltűnnek másodlagos hímségi, hegy, hímtag ill. élet nemzésére (megtermékenyítésre; lásd erről fentebb Kállay megfogalmazását is) és elvételére utaló jelentések.  
Ebben az esetben ráadásul magáról a Nap szavunkról van szó (nem [[B/BAR\|BAR]], vagy más szintén Nap és rokon jelentéssel megtalálható szóról).  

<!--section: 66-->
#### Kállay Ferenc A pogány magyarok vallása...

<!--section: 66.1-->
...című könyvéből is az derül ki, hogy Nap szavunk nemcsak az ég, felhő jelentésű szavakat, hanem az égbe nyúló hegy tetején található `snow` = hó idegen nyelvű szavait is kiadhatja, a szokásos IE sz-előtéttel:
> Kétséget sem szenved többé hogy Nubia = napföld volt, a Noba hegyek = naphegyek, hol a szent Nilus folyó forrásai rejlenek, mikép Ázsiában az Elbours hegyek, mint a Tigris forrásait magokban rejtők `napât`, `niphât` név alatt tiszteltettek, miből Strabo Niphatest csinált, s azt helytelenül görög szónak vévén, mások hóhegyeknek magyaráztak, pedig tulajdonkép Nabath hegyek. ([Lásd 301. old.](zotero://open-pdf/library/items/DFI47XPY?page=301&annotation=UWQCC4AV)) ^DFI47XPY-UWQCC4AV

<!--section: 67-->
### Nap papja, próféta

<!--section: 67.1-->
Ahogy [[N/Nap#^doo66p\|fentebb]] is szó volt róla, a pap a Nap nevét viselheti.  
Kállay alábbi kimutatásaiban is találunk erre vonatkozó adatot, próféta és más címek neveire:  
> Megvolt **Nobe** vagy nap papjai városa **Bethanuaba** név alatt, miről Reland írja: "video in hoc nomine urbis Nob deprehendere vestigium praefixa voce Beth, Hieronymus Nob et Diospolin (tehát isten városa) vicinas esse credidit" (Palaestina l. 1. Cap. 17. 20. és pag. 492. 667. 671.). A Betha nuaba másoknál Beto-anuabe = Nub vagy Nob temploma. ([Lásd 297. old.](zotero://open-pdf/library/items/DFI47XPY?page=297&annotation=ZL7RQIK4))
- Templom és ház itt is közös szón osztozik, mint [[E/É\|É]]-nél láttuk.

> Abubekre leánya (VI. század) Nabob vagy Nabia nevet viselt = prófétáné, ma is `nabi` arabul = próféta; turkul `nebbi`, `nabega`, Eichorn szerint az arab földön kiválólag költőt, poétát jelent, (Fundgruben des Orients VI. B. 3. Heft p. 233), ellenben az ó testamentom a `nabu` igeszót mindig a hamis prófétákra használja, Jeremiásban `nebü` igézők, álommagyarázók, azokkal osztályozvák, kik az igaz isten nevében hazudnak (l. példákat Allg. Lit. Zeit Julius 1834. Gesen szótára felett). ([Lásd 298. old.](zotero://open-pdf/library/items/DFI47XPY?page=298&annotation=8F8UKYKY))  
- Mindig megjelenik a negatív értelem.

> Az indus nábobok (apróbb fejedelmek) turk-arab, mongol `nab` és `naib` hivatalnevek, mint a `nabi` vagy Hammer szerint `nebi` jóslók közneve egyenesen a nab, nub, nap törzshöz köthetők, arabul `naba` ma is eminere, excellere, honnan Bochart szerint a nabath nép neve (Hierog. 1. 535.). Meninszkiben `náb` = princeps populi, familiae caput, `nabih` clarus et celebris vir, arabul, persául `náb` = purus, merus, sincerus, clarus, limpidus (t IV. p. 837.). ([Lásd 298. old.](zotero://open-pdf/library/items/DFI47XPY?page=298&annotation=JMPY9DK4))

<!--section: 68-->
## Csillagunk, a Nap

<!--section: 68.1-->
A Nap a legközelebbi csillag. Színképtípusa G2-es, átmérője 1,4 millió km körüli, tömege 333 ezerszerese Földünkének, átlagos sűrűsége 1,4 g/cm³. Eredeti anyagának kb. 74%-a hidrogén, 24%-a hélium, a nehezebb elemek aránya 2% körüli. A Nap külső rétegeiben jelenleg is ez az arány figyelhető meg, magjában azonban (mivel az anyag a Nap mélyén nem keveredik), a hélium mennyisége fokozatosan növekszik a hidrogén rovására. (Magjában jelenleg kb. 36% hidrogén, 62% hélium és 2% nehezebb elem található.)  
25 nap alatt fordul meg tengelye körül.  

A Nap felépítése  

A Nap belsejében saját tömegéből adódóan nagy nyomás és magas hőmérséklet uralkodik, így az anyag ionizált állapotban van. Centrumában a hőmérséklet 14-15 millió K, a nyomás 3x10¹¹ atmoszféra körüli, a sűrűség 155 g/cm³. A fúziós energiatermelő folyamatokhoz magas hőmérséklet és sűrűség szükséges, így azok csak a magban játszódnak le. Ez a Nap sugarának negyedéig terjed ki, de itt található az égitest tömegének mintegy fele. A Nap belsejében másodpercenként 600 millió tonna hidrogén atommag alakul át hélium atommaggá, ebből 4 millió tonna alakul energiává, melynek révén másodpercenként 3,8x1026J energiát termel. A Nap belső részében sugárzással terjed az energia, de a nagy anyagsűrűség miatt a fotonok még így is átlagosan egy másodpercenként ütköznek és véletlen irányba szóródnak. Egy fotonnak így 1 millió év nagyságrendű idő szükséges ahhoz, hogy a felszínre jusson – a Napnak ez az átlátszatlansága adja stabilitását. Amint kifelé haladunk a Nap belsejéből, a konvekció 150-200 ezer km mélyen indul meg, és az energia innen kezdve hatalmas buborékok formájában áramlik fölfelé. Ez a konvekciós réteg valószínűleg több egymásra épülő, fölfelé menet egyre kisebb méretű konvekciós cella szintből áll. (Jelenlegi ismereteink szerint legalul találhatók az óriáscellák, melyek átmérője 100 ezer km feletti, majd a 30 ezer km körüli szupergranulák következnek, ezután az 5-10 ezer km-es mezogranulák, végül pedig a granulák 1000 km körüli átlagos mérettel.) A konvekciós zóna aljáról az anyag kb. 1 hónap alatt ér a Nap felszínére.  

A Nap felszínén a 400-500 km vastag fotoszférát értjük, innen származik a Nap látható fénye. Itt 6000 K körüli a hőmérséklet, kb. 0,17 atmoszféra a nyomás és 10⁻⁶ g/cm³ sűrűség. (A fotoszféra alatti rétegeket a Nap belsejének, a felette elhelyezkedőket pedig a Nap légkörének nevezzük – ez utóbbit alkotja a kromoszféra és a [[K/Korona\|korona]].) Ezek szerint központi csillagunk nem rendelkezik szilárd felszínnel, a távcsőben látható napkorong pereme mégis éles. A jelenség oka, hogy a Földről nézve a 400-500 km vastag fotoszféra távcsöveink felbontóképessége alatt marad. A szilárd felszín hiányáról egyébként könnyen meggyőződhetünk fotografikus úton. Már a kisebb távcsövekkel készített felvételeken is fel lehet figyelni a szélsötétedésre: a napkorong fénye kismértékben csökken, amint a közepétől pereme felé haladunk. Ennek oka, hogy a Nap anyagában – annak átlátszatlansága miatt – csak meghatározott távolságon láthatunk keresztül. Mivel a korong közepén lévő tartományokra közel merőlegesen tekintünk, ott mélyebben fekvő, forróbb és erősebben sugárzó rétegeket pillanthatunk meg, mint amikor a korong pereménél "ferdén" nézünk a Napba.  

A Nap nem merevtestként forog, hanem differenciálisan rotál, azaz forgási ideje széles-ségenként változik. A sarkok közelében a tengelyforgási idő 37 nap körüli, míg az egyenlítőnél kb. 26 nap – ennek megfelelően mozognak a felszíni képződmények is. A differenciális rotáció pontos oka egyelőre nem ismert.  

A Nap légkörének jelenségei  

A korábban már említett granulák a fotoszféra átlagosan 1000 km átmérőjű képződményei, élettartamuk 6-10 perc körüli. Egy-egy granula belsejében 1-2 km/s-os sebességgel áramlik felfelé az anyag, ez a tartomány világosabbnak látszik, mivel forróbb a környezeténél. Energiája egy részét a felszínre jutva kisugározza, majd a granula külső, sötétebb részén az immár hidegebb anyag visszaáramlik. A granulák teljesen beborítják a fotoszférát, szemcsés, márványos megjelenést adva annak. A szpikulák hosszúkás, kúp alakú képződmények, szélességük 700-1000 km alapjuknál, magasságuk 5-15 ezer km, így a koronába is felnyúl-hatnak. Hatalmas számban találhatók a napkorongon, átlagos élettartamuk 4-10 perc körüli. Megfigyeléseink szerint a szupergranulák határainál, az összesűrűsödő erővonalaknál helyezkednek el.  
...
A fáklyamezők a fotoszféra, illetve a felette elhelyezkedő kromoszféra képződményei. A fotoszféránál néhány száz fokkal melegebbek, így annál fényesebb képződmények, gyakran a napfoltok körül mutatkoznak, de 35 fokos szélesség felett is megfigyelhetők. A fáklyák élettartama változó, legtöbbször csak órákban mérhető, de elérheti az egy hónapot is.  

A protuberanciák a fotoszféra felett lebegő hatalmas gáztömegek, a Nap légkörének talán leglátványosabb képződményei. Anyaguk sűrűbb és hidegebb a kromoszféránál, átlagos méretük 100 ezer km körüli. Két fő típusukat érdemes megemlíteni: a nyugodt és az aktív protuberanciákat. A nyugodt protuberanciák élettartama nagyságrendileg egy hónap, anya-gukat a fotoszférából kinyúló erővonalak tartják lebegve, illetve azok mentén áramlanak vissza a Napba. Az aktív vagy robbanó protuberanciák ezzel ellentétben gyors változásokat mutató, rövidéletű képződmények. A bennük lévő anyag néhány száz km/s-os sebességgel lökődik ki, a nagyobb protuberanciák anyagának egy része el is hagyhatja a Napot. A korong szélén lévő protuberanciákat az égi háttér előtt világosnak látjuk, míg ha a protuberancia a korong előtt helyezkedik el, sötétebbnek mutatkozik, mint a fotoszféra – ekkor filamenteknek nevezzük őket.  

Flerek (napkitörések): Rövid életű, néhány perces, rendkívül heves, a napfoltokhoz kapcsolódó robbanásos jelenségek. Gyakoriságuk változó, a naptevékenység maximumakor többször tíz kisebb-nagyobb flerjelenség történik naponta. Valószínűleg ellentétes mágneses terek találkozásakor hirtelen felszabaduló energia hozza létre őket. Hőmérsékletük többször tízmillió fok is lehet, azaz meghaladhatja a Nap belsejében uralkodó hőmérsékletet. Anyaguk kilövellési sebessége eléri az 1000 km/s-ot, így egyetlen alkalommal akár több millió tonnányi anyag is elhagyhatja a Napot.  

A kromoszféra a fotoszféra felett elhelyezkedő kb. 10 ezer km vastag réteg. Amint a fotoszférából kifelé haladunk, folyamatosan csökken a hőmérséklet, és nemsokára eléri a 4500 K-es minimumot – itt kezdődik a kromoszféra. Ennek anyaga ritka, teljes napfogyatkozások alkalmával vékony rózsaszín rétegként figyelhető meg a Nap felszíne felett. Átlagos hőmérséklete 10 ezer K. Felső határánál egy néhány száz km-es átmeneti réteg található, melyben felfelé haladva rendkívül gyorsan nő a hőmérséklet, mely végül eléri az egymillió fokot, itt a sűrűség 10⁻¹⁶ g/cm³.  

A [[K/Korona\|korona]] a kromoszféra után következő réteg, 10-20 ezer km-rel kezdődik a fotoszféra felett, ez a Nap légkörének legkülső, ritka tartománya. A belső korona kb. 2 napsugárnyira terjed ki a Nap felszínétől, itt a maximális hőmérséklet 1,5 millió K. A külső koronában 1 millió K körüli a hőmérséklet, ennek határát gyakorlatilag nem lehet meghúzni, ugyanis folyamatosan megy át a ritka bolygóközi térbe. A kromoszféra és a korona magas hőmérsékletéért a fotoszféra vad jelenségei a felelősek. Többek között a lentről származó akusztikus lökéshullámok, magneto-hidrodinamikus hullámok fűtik fel azt – a jelenség pontos háttere egyelőre nem ismert. A korona szálas szerkezetet mutat, napfoltmaximumkor közel gömbszerű, napfoltminimumkor a pólusoknál belapul, ekkor látványosabb. A magas hőmérséklet következtében a korona anyaga eléri és meg is haladja a szökési sebességet, ezért rendkívül gyorsan áramlik kifelé. Ezt a részecskeáramot nevezzük napszélnek, melynek révén a Nap másodpercenként 3 millió tonnányi anyagot veszít. Induló sebessége 4000 km/s körüli, a Naptól távolodva fokozatosan lassul, a Föld távolságában átlagosan 400 km/s-os, sűrűsége itt általában 10 részecske cm³-enként. A korona anyaga nem egyenletesen szóródik szét. A napszél nagy része ugyanis az úgynevezett koronalyukakból fúj a pólusok környékén, itt a mágneses erővonalak nem alkotnak zárt hurkot. Ezek a régiók sötétebbnek mutatkoznak környezetüknél, bennük a gáz sűrűsége kisebb, mint a környező koronában, és a hőmérséklet is csak feleakkora.  

A kiáramlott töltött részecskék mágneses teret is visznek magukkal, amely a Nap tengelyforgása következtében felcsavarodik, és spirális alakot ölt a Naprendszerben. A napszél természetesen impulzusmomentumot is szállít a Napból, aminek következtében központi csillagunk tengelyforgása kismértékben lassul. A Nap északi és déli részéről kiáramló töltött részecskék tömegét a Nap egyenlítői síkja közelében elhelyezkedő semleges áramréteg választja ketté. Ez a sík kisebb-nagyobb szabálytalanságok miatt deformálódik, hullámos lesz. Ennek következtében a bolygók síkjában ellentétes polaritású szektorok váltakoznak, az égitestek hol északi, hol déli polaritású részekbe lépnek be. A Napból a napszél formájában kiáramlott részecskék folyamatosan ütköznek bolygónk magnetoszférájával. Amikor felerősödik áramlásuk, a Földön sarki fényt és geomágneses viharokat lehet megfigyelni. Hasonló hatást válthatnak ki a napflerek által kidobott részecsketömegek.  

A Nap mindegy 4,5 milliárd évvel ezelőtt került a fősorozatra, akkor sugárzása a jelenleginél közel 30%-kal gyengébb volt. Üzemanyaga még kb. 5 milliárd évre elegendő magjában, majd elfogyta után vörös óriás állapotba kerül. Erős sugárzása elpárologtatja a bolygók vizét és légkörét, a Merkúr, a Vénusz és talán még a Föld is a Nap kiterjedt belsejében fognak keringeni. Végül központi csillagunk külső rétegei elszállnak, és a szénben, oxigénben gazdag mag fehér törpe állapotban marad vissza.  

A Nap helye a csillagok között  

A csillagok energiasugárzásukat tekintve széles skálán mozognak. Találhatunk olyan csillagokat, amelyek milliószor annyi energiát bocsátanak ki, mint a Nap, de ugyanakkor olyanok is akadnak, amelyek Napunk sugárzásának csak milliomodával pislákolnak. A nagy változatosság részben a csillagfejlődés különböző állapotaival, részben pedig az egyes fősorozati csillagok különböző tömegével függ össze. Természetesen a fényes csillagok a feltűnőbbek, így míg a nagy energiakibocsátásúak távolról is megfigyelhetők, addig a kisebbek még közelről se nagyon vehetők észre. Éppen ezért az éjszakai égen megfigyelhető csillagok látszó fényességében a csillag sugárzása fontosabb szerepet játszik, mint távolsága. A csillag szó kapcsán általában hatalmas, rendkívül nagy energiakibocsátású égitest jut az eszünkbe. Az ismeretterjesztő könyvekben gyakran elhangzik az a kijelentés, mely szerint "a Nap átlagos csillag". Ez ebben a formában nem igaz, a valóságban ugyanis a csillagok nagy része sokkal halványabb a Napnál. A környezetünkben található csillagoknak kb. 70%-a vörös törpe – azaz a Napnál sokkal kisebb tömegű és energiakibocsátású égitest. A K színképosztályba tartozó, már nagyobb energiakibocsátású csillagok száma 15% körüli, majd pedig a csillagfejlődés egyik végállapotát képviselő objektumok következnek, a fehér törpéknek, melyek aránya 10%. Ezek szerint a Tejútrendszerben megfigyelhető csillagoknak nagyjából 95%-a halványabb a Napnál. Tehát központi csillagunk a maradék "elit" 5%-ba tartozik, úgy is mondhatjuk, hogy a felső tízezer tagja. Természetesen ez nem azt jelenti, hogy rendkívüli objektum lenne. Hozzá hasonló sokmillió van még galaxisunkban, és olyanok is nagyszámban akadnak, amelyek sugárzása több nagyságrenddel múlja felül a mi Napunkét – ebből a szempontból akár átlagos csillagnak is tekinthetnénk.  

Napunk valószínűleg(??) magányos, egyedüli csillag. Jelenlegi ismereteink szerint a csillagoknak nagyjából a fele kettős vagy többszörös rendszerekben helyezkedik el, ahol több csillag kering egymás körül – másik felük pedig a Napunkhoz hasonló(??) egyedüli égitest.  
Más adatok szerint (lásd például Walter Cruttenden-féle videót Uwe Homannal) a csillagok 80%-a (legalább) bináris.  
Lásd még [[N/Nap#Csillagunk, a Nap\|csillagunk a Nap]], [[T/Tejútrendszer\|Tejútrendszer]], [[F/Fekete lyuk\|fekete lyuk]], [[N/Naprendszerünk mozgása\|Naprendszerünk mozgása]], stb.  

<!--section: 69-->
# Nap 2)

<!--section: 69.1-->
Nem az éjszakai, hanem nappali alvás, szunyálás szava. Már akár a szunyál szó is [[S/Sun\|Sun]] szóval vetendő össze. A nyilván nem angol eredetű japán `neburu`/`nemuru` = aludni; halni is ilyen szó (ha nem a hálni > nemzeni értelmet kell itt keresni).  
Argóbani elcsíp jelentését lásd [[N/Nab\|nab]].  
...
[^1]: Lábjegyzet:  
Az obi-ugor nyelv-rokonaink aranyszínű napistenének neve kapcsán Jankovics Marcell írja, hogy Pi, Piris "fiúgyermeket" jelent és a Napra vonatkozik.  

[^2]: Lábjegyzet:  
Már Kandra Kabos Magyar Mythologia című könyvének (a PDF) 33. oldalán vogul adatként előjön `náj-pi` = asszony fia, nap jelentésben. A 71. oldalon pedig szintén érinti a témát.  
Az alábbi [[T/Tündér Ilona\|Tündér Ilona]], [[T/Tojás\|tojás]] és [[K/Kuk\|kuk]] címnél is álló Jankovics Marcell féle adat szerint nem is lenne dőreség:  
Tündér Ilonát viszont az erdélyi Nyárád-patak mentén egyenesen a Napot, Holdat szülő tejútanyának tekintették. "Húsvétkor a gyermekek azt játszották, hogy tojásokat dobtak 'kukkba', azaz fel az égbe vagy az ég felé. A játékot 'napcsinálásnak' nevezték. A nap először egy tojás volt, amit Tündér Ilona rakott, amikor hattyúvá változtatták." (Róheim 1984: 147.)  

[^3]: Lábjegyzet:  
Jankovics Marcell szerint:  
Általánosságban elmondható, hogy a "nő Nap" "férfi Hold" páros az archaikusabb mítoszokra jellemző.  
...
[^5]: Lábjegyzet:  
Az aranyat ugye a Nap fémének tekintette a világ minden népe.  

[^6]: Lábjegyzet:  
[[N/Nyilas csillagkép\|Nyilas csillagkép]] (valamint [[D/Diana\|Diana]] és [[A/Artemisz\|Artemisz]]) címszóhoz is betéve.  

[^7]: Lábjegyzet:  
Másképpen: az egymással átellenben lévő csillagképeket annak okán, hogy amikor egyikük Nap(fény)be öltözik, akkor látható éjszaka a másik, az egyidejű megfigyelés során eleink képzelete összekapcsolta.  
Példák sorát ismerjük már: [[P/Pán\|Pán]], [[S/Suhurmasku\|Suhurmasku]], [[M/Magyar mint Szíriusz\|Magyar mint Szíriusz]] és sok más címnél taglaltuk ezt a témát. A közös mindig annak látszik, hogy Szíriusz együtt áll a Nappal és a Földdel a Nap feltámadásánál (a Bakban).  
—  
Az asztrológiai tengelyek, mint például a [[S/Szűz-Halak tengely\|Szűz-Halak tengely]] is precessziós értelemben ilyen fontosságú, annak figyelembe vételével, hogy a tavaszponti Nap meghatározó arra vonatkozólag, hogy a Föld és ég emberiség hol tart.  

[^8]: Lábjegyzet:  
Mivel arameusul – ez volt Jézus idejében a Közel-Kelet lingua francája, érintkezési nyelve – teomo "ikret" jelent. Viszont Robert Brown Jr. Primitive Constellations of the Greeks, Phoenicians and Babylonians című könyvében (második kötetében) Ikreknél szóba sem került ezen eshetőség (nem mintha arámi nyelvvel foglalkozott volna). Arról lehet szó, hogy a sumér-akkád [[M/Mastabbagalgal\|Mastabbagalgal]] Mastamma-Galgal-nak lett felfogva, és a Mas utáni Tamma is ikreknek lett véve, ha jól sejtem.  

[^9]: Lábjegyzet:  
A csíki székelyek és a gyimesi csángók a Holdat Babbának nevezik, a Napbaöltözött Asszonyt, a Hold Asszonyát pedig Babba Máriának. A csatolt képen a csíksomlyói Babba Mária szerepel. Jól látszanak a napsugarak körötte. Nagyné dr. Fülöp Krisztina Mária élete, édesanyák lelke című Ősi Gyökér 2006/1. sz. megjelent cikkében is így írja:  
Boldogasszony a csíki székelységben, a gyimesvölgyi csángóknál és Moldvában az úgynevezett székelyező csángóknál Babba Máriának neveztetik; a kereszténység előtt, feltehetően csupán Babbának. Ezeken a vidékeken **a napbaöltözött égitestet, a Holdat** is Babbának nevezik, s e szó melléknévi változatában (babbás) szépet, szépségest jelent.  
A Hold Babba nevéről Molnár V. József írásait is lásd [[B/Babba Mária\|Babba Mária]].  

[^10]: Lábjegyzet:  
Gyárfás Ágnes szintén a Szíriusz Boldogasszonyként való ábrázolása című cikkében a Boldogasszonnyal kapcsolatos ünnepek tárgyalásában is érdekesen írja az [[U/Újév\|újév]]i, január elsejei dátum mellé, hogy ekkor, amikor a Szíriusz delel, ekkor van a [[B/Boldog\|boldog]] állapota ([[B/Boldogasszony\|Boldogasszony]] nevében Bol-Dog Péterfai Jánosnál és nálam is ilyenképpen értelmezett). [[U/Újév\|Újév]] címnél lásd bővebben. [[B/Boldog\|Boldog]] címnél is megvolt.  

[^11]: Lábjegyzet:  
[[K/Kalács\|Kalács]] és [[U/Újév\|újév]] címnél is szerepelt:  
[[A/Az aranyhajú királyfik mese\|Az aranyhajú királyfik mese]] Gyárfás Ágnes féle elemzésében Szíriusz égi magatartását elemezve írja, hogy fél évig láthatatlan, de január 1-én teljes fénnyel ragyog és uralkodik a csillagok felett. Aztán július 1-én reggel együtt kel fel a nappal a horizont legalsó rétegében. Ettől kezdve emelkedik újra felfelé, hogy január 1-én az égbolt tetejére érjen és újra találkozzék férjével, Orionnal. Ez az ő boldog állapota.  

[^12]: Lábjegyzet:  
Ugyanez a kérdés jön elő a Tejút (forgása) kapcsán is (mely ugye napi, éves és Nagy Éves elforgást is mutat).  
Robert Brown Jr. Primitive Constellations of the Greeks, Phoenicians and Babylonians című könyvének (második kötetének) 34-35. oldalán a Tejút novemberi és májusi állását írja körül. Jó lenne látni a képeket, de nem sikerült megtalálni sehogy sem. Mindenesetre Brown körülírása ettől még hasznos.  
**Sosem értettem viszont, hogy a Tejút állását mikor kell ellenőrizni (azon kívül, hogy éjszaka), ugyanis a 24 órás időintervallumon belül is forog.**  
Ráadásul változik aszerint is, hogy a Föld melyik koordinátáján vagyunk. [[K/Karácsony\|Karácsony]] címnél volt szó arról, hogy a Tejút függőleges december 24. éjfélkor, 25.-ére virradóra.  
Azóta [[T/Tejút\|Tejút]] címnél legalul új alcímnél (*Tejút iránya*) foglalkoztunk a témával: némiképp (Nagy Éves olvasatát) helyretettük.  

[^13]: Lábjegyzet:  
Lásd Magyar Adorján Csodaszarvas PDF 54. oldalán. Ez a rész másutt is állt:  
[[H/Héra\|Héra]] pedig azonos a mi Nagy Ősanyagistennőnkkel, azaz a Napisten anyjával, aki hiszen a Tejút megszemélyesítése volt; más szóval: a Tejút azon sok tej amelyet az említett óriások isznak és amelytől nagy erejüket kapták. Orion, Kilenc, Heraklész tehát azonosak a mi Napistenünkkel, azaz Magyarral; de azonosak még [[F/Fehérlófia\|Fehérlófia]] nevű mesebeli hősünkkel is, akit a Fehér Ló háromszor hét esztendeig szoptatott, amitől rettentő erejűvé lett.  
—  
A Badiny Jós Ferenc Nimród nyomában című Bunyevácz Zsuzsa által készített cikkben is elhangzik, hogy van adatunk arra is, hogy az Oriont Herkulesnek is nevezték.  

[^14]: Lábjegyzet:  
Wikipédia oldalán olvasni:  
A [[V/Világügyelő\|világügyelő]] Férfi (Mir Susne Hum) a manysi (vogul) mitológia egyik központi alakja. [[N/Numi Tórem\|Numi Tórem]] fiaként feladata a világ rendjének fenntartása (például Nap és Hold mozgásának biztosítása). Más istenekkel szemben gyakran kiáll az emberek érdekeinek védelmében, ezért bálványait nagy tisztelet övezte, a hódítók és misszionárusok elől mindig elrejtették. Egyes feltételezések szerint alakjára a későbbi korokban krisztusi legendák is hatással voltak. Egyéb nevei: Arany Atyácska (Sorni ater), Lúdfejedelem (mivel bálványa lúd), Daruláb-sítalp-bőr. Az osztják és szamojéd népeknél is létezik alakjával azonosítható mitikus személy.  
...
[^15]: Lábjegyzet:  
Az ősi kollektív nemzet-tudatban az Isten és az ember közti átmenetet a "hős" vagy nemzet-ős képezte. Úgy tekintettek rájuk, hogy nem emberi, nem földi, hanem égi származásúak, Istentől küldött emberek voltak. "Ősi emlékeink", mondja Ipolyi Arnold, "határozott nemzeti hősi, ősvallási kultuszra utalnak".  

[^16]: Lábjegyzet:  
[[A/Andor\|Andor]] név elemzésénél írtuk, hogy Ég Ura értelmű is, de az Úr itt egy T-előtétet kap. Mivel (Nap az) Orion(ban) értelemben kell rá tekintenünk, nem lehet a [[T/TUR\|TUR]] és [[T/Tura\|Tura]] címnél taglalt Fiú jelentéssel számolni: Orion nem lehet Fiú, mert a Nap azon kis éves állásában már élete delelőjén tart. Itt a [[D/Dél\|dél]]-delelő(je) értelemre hívnám fel a figyelmet. Ugyanis a Sagittarius-Nyilas a déli irány, viszont más értelmezésben a dél Orionra utal, legalábbis ilyenkor, a nyári napfordulón áll legmagasabban a delelő Nap. Ilyenkor van "[[U/Ugor\|Ugor]]" (ÚR – [[U/UR\|UR]] = sumér-óegyiptomi kutya) állásában a Nap.  

[^17]: Lábjegyzet:  
Quorán  [ezen](https://qr.ae/pNfUQD) helyen is felírtam egy kommentbe:  
...
—  
A `Vasárnap` régebbi, mint a `Bazaar`, mivel a Vasárnap eredeti jelentése nem "Bazaar/Vásár Napja", hanem Nap (Isten) napja. A Vas-Ár tehát a Nap Úrra is utal. Vas-Ár = Vez-Ér.  
——  
...
—  
A mai nemzetek közül sok akkor jött létre, amikor az úgynevezett csillagvallást felváltotta a Napvallás. A Nap nevei lehetnek Orion nevei is, amely Orion Isten csillagképe volt, úgymond. A Pater, Vezér, Vasár (Er, Ér, Ár mind Úr jelentésű) ugyanazok a szóformák. Nehéz megmondani, hogy eredetileg Nap- vagy Orion-nevek voltak-e. Alapvetően azt mondhatjuk, hogy amikor a Nap nyáron eljut Orionhoz, akkor eggyé válnak.  

[^18]: Lábjegyzet:  
Kállay adata szintén:  
Európában a germán földi felírások közt **Diana Abnoba** istenné is áll, mely ott mint Visucius is honni módon tiszteltetett, a pforzheimi feliratban már Nobe olyasható, mindenik az Abnoba hegyek nevével szoros kapcsolatban áll, melyek a mai Schwarzwald egy részét tették, (Jahrb. für wiss. Kritik 1834. Aug. Nro 26.), Venantius Fortunatus Naab vizet említi épen Thuringiában, hol a Frankok a VI. században győzedelmeskedtek "Quam Nabis ecce probat Thuringia victa fatetur (l. W. Jahrb. LVIII. B. p. 81.), Meier szerint a thuringiai földön az egyszerű törzsszó is fennmaradt, u. m. `nap` = urceus rostratus, a belga `naph` = poculum (Leibnitzü Collect. Etym. P. II. p. 263.)  
Tacitus a Dunát Abnoba hegyről eredetezteti "Danubius molli et clementer edito montis Abnobae jugo effuso" a ravennasi névtelen geographus is Thuringiában Nab folyóvizről szól. ([Lásd 303. old.](zotero://open-pdf/library/items/DFI47XPY?page=303&annotation=BHX3HZUM))  

</div></div>


Kállay A pogány magyarok vallása című könyvében talált egyéb adatai (más holddal kapcsolatos sorait lásd [[M/Manó\|manó]]):  
> A Men név épen ugy mint a Man szóról láttuk, gyakori az országok s népek neveiben, mint Artamenes, Komana, Armenia, az ótestamentomban, Mini, Meni, vagyis a hold mint a fátum istenasszonya emlittetik Jesaiásnál, (65. 11.) mivel a pontusi királyok szokott esküje Pharnaces Men-jére (hold) összefüggésben áll. ([Lásd 277. old.](zotero://open-pdf/library/items/DFI47XPY?page=277&annotation=5JY2CFP3))  
> 
> Az ó-testamentomi meni bálvány hát minden esetre a holdat illeti, mit az indus `summat`, v. `summenath` bálvány név is, mint előadtuk, a meny szó alatt igazol, s a zsidó, arab `manah` ige = determinavit, numeravit, destinavit, a hold járását, időszakjait fejezte ki, épen ugy mint a német `manez` ige, honnan `Monath`, `Menot`. ([Lásd 277. old.](zotero://open-pdf/library/items/DFI47XPY?page=277&annotation=Q5NIVH25))  
> \[...\]  
> Arabul `menath` = fatum, fortuna, tehát Venus szerencse-csillagzata, de Indiában is megvan az a menath-bálvány s azt épen az oda költözött arabok vitték át, indus neve Summat, `sum` hindouk nyelvén = hold, `naat`, `nat` = tisztelni, honnan a helység neve is (Wien Jahrb. XXXVI. B. p. 252.). ([Lásd 287. old.](zotero://open-pdf/library/items/DFI47XPY?page=287&annotation=A3EXRSR5))
- Richard H. Allen könyvében Orion lambdájánál előjön egy ind **Soma** név Hold jelentéssel.
 
> Ottfried, a XI. században már él a Manó szóval = hold. Jäkel (p. 59.) `Mane`, `Man`, `Manen` alakzatjait közli.  
> Hagen pedig igy ir: "Menian (main), minan davon `mȇna` der Mond als Zähler der Zeit, and Man (der Stammvater Mannus) der Sinne ende (Mann im Monde) ganz wie von dem indischen Urvater Mann (der denkende) aller Menschen Manuscha, Manus, Kinder heissen" (J. f. W. Kritik 1834 Aug. Nro 38.) ([Lásd 278. old.](zotero://open-pdf/library/items/DFI47XPY?page=278&annotation=3LR4PTKU))  
> Grimm szinte `Mȇna`, `manô`, `mânot`, `mano` szóformákat közöl hold értelemben. ([Lásd 278. old.](zotero://open-pdf/library/items/DFI47XPY?page=278&annotation=8ISM6RQF))
- Hagen: "Menian (main), melynek minan a hold az idő számlálójaként 'mȇna', és az ember (a Mannus ősatyja) az érzékek (ember a holdban) éppúgy, mint minden ember indiai ősatyjától Man (a gondolkodó) Manuscha, Manus, hívják a gyerekeket."

> A hód neve is görögül az ember képről `mene`, németül `mon`, `mane`, `mone`, `maen`, lappul `manna` = Monath (in voce Man). ([Lásd 278. old.](zotero://open-pdf/library/items/DFI47XPY?page=278&annotation=6CPA2NWC))
- Egyáltalán nem biztos, hogy az ember ([[M/Man\|man]]) arca nyomán ered a hold neve. Nyilván bele lehet rajzolni.

> A görög `mainomai` = insanio, `mania` = furor, hihetőleg a hold phasisait fejezék kezdetben ki, mert a babonás hit szerint azok az ellenerők küzdéseire magyaráztattak; ma is a hold s napfogyatkozások a tudatlan népeknél rémülést okoznak, s schamán papjaiknak kell közbejárni, hogy mindenféle cselfogásaikkal megnyugtassák a népet, de a `mantis` szó (= vates) Bapp szerint nem onnan jő, hanem a man törzsből (= denken), honnan sanskrit nyelvben `matis` = scientia, a görög `mathe` és `mantr`, a görög `mantĭs`, ki szent könyörgéseket mond el (Allg. Lit. Z. Julius 1834. Nro. 115.). ([Lásd 279. old.](zotero://open-pdf/library/items/DFI47XPY?page=279&annotation=FVENVBNE))
