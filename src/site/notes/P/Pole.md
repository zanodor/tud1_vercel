---
{"dg-publish":true,"permalink":"/P/Pole/","title":"Pole","tags":["Englishtexttranslated"],"created":"2024-04-20T13:44","updated":"2026-05-29T22:43"}
---
...
Hogy a Sarkcsillag lehet-e átjáró, kapu, nem tudni, de a másutt, [[K/Kapu\|kapu]] és [[C/Castor és Pollux\|Pollux]] címnél Jankovics Marcell által is említett `πύλος` (`pülosz`)[^1] = kapu szinte azonos a görög `pólosz` és latin `polus` szóval. És mivel Pollux neve is azonosul vele (senki sem veszi észre az egyezést?) és az Ikrekben van a másik átjáró/kapu, megmagyarázza a nevét.  
A [[S/Szíriusz és a Sarkcsillag\|Szíriusz és a Sarkcsillag]] címnél írottak alapján az északi kapu fogalma átmehet akár a Sarkcsillag nevére. Ilyenképpen a Farkasinszky Tibor által [[T/Typhon\|Tüphón]] címnél bemutatott (azóta [[B/Bál#Bál-Göncöl\|Bál-Göncöl]] cím/alcímhez is betett) Bál-Göncöl nem is rossz gondolat. Bál-Nimrud (lásd róla [[B/Bál\|Bál]] címnél, külön alcímnél) a nyári napfordulós magas napállás fogalma nyomán lehet B-L vázú Sarkcsillag nevet létrehozó.  
...
> The Greek root `φύω` (`phúō`) means "to bring forth" and the Greek `φυλή` (`phulē`) "clan, race, people" (plural `φυλαί` (`phylai`)). The Greek `polis` ("state" or "city") was, like the Roman state, often divided into phylai.  
> —  
> A görög `φύω` (`phúō`) gyök jelentése "kihordani", a görög `φυλή` (`phulē`) pedig "nemzetség, faj, nép" (többes számban `φυλαί` (`phylai`)). A görög `polis`-t ("állam" vagy "város") a római államhoz hasonlóan gyakran phylēkre osztották.  
- Ide megjegyzés: általán (ahogy [[Q/Quarter\|quarter]] és [[K/Kereszt\|kereszt]] címnél is volt erről szó) negyedelték a városokat, de ezen görög szavak a [[F/Falu\|falu]] szóra látszanak mutatni. [[F/Fél#Felezés mint kettévágás – Tejút sávja általi osztás\|Fél]] címhez is betéve.
- Vö. össze még [[P/People\|people]] és [[F/Folk\|folk]].
...
- Itt magyar rokon vázú részről a [[V/Vált\|vált]] és [[F/Forog\|forog]] mutatná jól rokon fogalmakat.

Különösen a Götz könyvének 191. oldalán is taglalt sumér `BAL` = forgat, orsó, forduló érdekes.
{ #250102}
...
Tulajdonképpen kimondható, hogy az avar-hun For gyök F-P és R-L változásos palóc Pol párjáról van szó. A forduló, mint tudjuk [[D/Door\|door]] témája kapcsán is, nem más mint kapu, azaz a görög `πύλος` (`pülosz`) = kapu eredete is innen jön.  
...
[^1]: Lábjegyzet:  
Érdekes a `πύλος` (`pülosz`) elnevezés (Jankovics Marcell írja):  
